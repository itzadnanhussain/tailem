                    ...
                    <div style="margin-top:0;">
                        <form name="add_to_playlist" id="add_to_playlist" method="post" style="padding:10px; padding-top:20px;">
                            ...
                            <h4 style="font-size:20px; font-weight:normal; margin-bottom:20px; width:95%;">
                                ...
                                ?>
                                Add <a style="color:#d73b3b;"><?php echo $song_title; ?></a> to Playlist
                            </h4>
                            ...
                            ?>
                                    ...
                                    <?php } else { ?>
                                        <div class="row">
                                            <div class="col-md-12" style="margin:5px 0 5px 0">
                                                <input type="checkbox" name="playlist_arr[]" value="<?php echo $arr_playlist['id']; ?>" style="margin-top:-1px;">
                                                <?php echo stripslashes($arr_playlist['title_playlist']); ?>
                                                <!-- <input type="hidden" name="playlist_title" value="<?php echo stripslashes($arr_playlist['title_playlist']); ?>"> -->
                                ...
                                <span style="margin-top:15px; display:inline; width:40%; float:right; background-color:#D73B3B; border-color:#D73B3B;" class="btn btn-md btn-primary btn-block" type="button" data-dismiss="modal">Cancel</span>
                            <?php
                            }
