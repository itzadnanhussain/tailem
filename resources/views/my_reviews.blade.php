...
<section class="middle_sec myreviews">
    ...
    white-space: nowrap;
    width: 100%;"><?php if ($feature_artists != "") { ?> <strong class="heart_color" style="font-size:16px; font-weight:500; vertical-align:top; ">ft.</strong> <?php echo $feature_artists;
                                                                                                                                                            } ?></label><br>
                                                <label class="likes">
                                                    <?php
    ...
    text-overflow: ellipsis;
    white-space: nowrap;
    width: 100%;"><strong class="heart_color" style="font-size:16px; font-weight:500; vertical-align:top;">ft.</strong> <?php echo $feature_artists; ?></label><br>
                                            <?php } ?>
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 pad_zero rew_item">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-left:2px; padding-right:16px;">
                                                                ...
                                                                if ($user_id != "") {
                                                                    ...
                                                                    <span class="like-group" style="float:right; line-height:20px !important;" id="other_dis_sub_profile_<?php echo $sr_no; ?>">
                                                                        ...
                                                                        ?>
                                                                        <a href="<?php echo SERVER_ROOTPATH; ?>process/detail_profile?user=<?php echo urlencode($user_name); ?>&critaria=1" data-toggle="modal" data-target="#missing_popular_review_Modal2_<?php echo $sr_no; ?>" data-title="" class="like link-disable" style="color:#FFFFFF;"> <?php echo $counter_main; ?></a></span>
                                                                    <span class="like-group" style="float:right; line-height:20px !important;" id="myStyle_sub_profile_<?php echo $sr_no; ?>"></span>
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8 desc_pan pad_zero">
                                            <p class="title" style="margin-bottom:5px;"><span style="background-color:<?php echo $color_pick; ?>; border-radius:5px;"><?php if ($review_rating == 10) {
                                                                                                                                                                            ...
                                                                                                                                                                            echo $review_rating;
                                                                                                                                                                        } ?></span> <a style="color:#000000;" href="<?php echo SERVER_ROOTPATH . $song_seo . "/reviewslist/" . $artist_seo . "/" . $position_find . "#review_" . $review_id; ?>"><?php
                                                                                                                                                                                                                                                                                                                                                    $title_rev  = substr(wordwrap($review_title, 15, ' ', true), 0, 18);
                                                                                                                                                                                                                                                                                                                                                    echo $title_rev;
                                                                                                                                                                                                                                                                                                                                                    if (strlen($review_title) > 18) {
                                                                                                                                                                                                                                                                                                                                                        echo "..";
                                                                                                                                                                                                                                                                                                                                                    } ?></a></p>
                                            <p style="color:#000000; margin-bottom:8px;"><a style="color:#000000; margin-bottom:8px;" href="<?php echo SERVER_ROOTPATH . $song_seo . "/reviewslist/" . $artist_seo . "/" . $position_find . "#review_" . $review_id; ?>"><?php
                                    ...
                                    <div class="rew_item">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-9 desc_pan pad_zero mrg_15" style="float:right;">
                                            <p class="title" style="margin-bottom:5px;"><span style="background-color:<?php echo $color_pick; ?>; border-radius:5px;"><?php if ($review_rating == 10) {
                                                                                                                                                                            ...
                                                                                                                                                                            echo $review_rating;
                                                                                                                                                                        } ?></span> <a style="color:#000000;  font-family:sans-serif !important; font-size:18px;" href="<?php echo SERVER_ROOTPATH . $song_seo . "/reviewslist/" . $artist_seo . "/" . $position_find . "#review_" . $review_id; ?>"><?php
    ...
    text-overflow: ellipsis;
    white-space: nowrap;
    width: 100%;"><?php echo "ft. " . $feature_artists; ?></label></p><?php } ?>
                                        ...
                                        <div class="rew_item" style="border:none; padding:0 0 12px 0;">
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 desc_pan pad_zero">
                                                <p class="title"> <span style="background-color:<?php echo $color_pick; ?>; border-radius:5px; font-size:12px;"><?php if ($review_rating == 10) {
                                                                                                                                                                    ...
                                                                                                                                                                    echo $review_rating;
                                                                                                                                                                } ?></span><a href="<?php echo SERVER_ROOTPATH . $song_seo . "/reviewslist/" . $artist_seo . "/" . $position_find . "#review_" . $review_id; ?>"><text class="rec_review_title"><?php
                                                            ...
                                                            <div class="row">
                                                                <div class="like_right" style="padding-right:18px;">
                                                                    ...
                                                                    if ($user_id != "") {
                                                                        ...
                                                                        ?>
                                                                            <span class="like-group" style="line-height:20px !important;" id="other_dis_sub_profile_mb_<?php echo $sr_no; ?>"><a href="javascript:;" onClick="add_in_favourite_user_profile_mob('<?php echo $db_review_user_id; ?>','<?php echo $sr_no; ?>','<?php echo $user_name; ?>')"><i class="fa fa-heart" style="color:#d73b3b !important; font-size:14px;"></i> </a><a href="<?php echo SERVER_ROOTPATH; ?>process/detail_profile?user=<?php echo urlencode($user_name); ?>&critaria=1" data-toggle="modal" data-target="#missing_popular_review_Modal2_<?php echo $sr_no; ?>" data-title="" class="like link-disable" style="color:#fff; font-size:12px;"> <?php echo $counter_main; ?></a></span>
                                                                            <span class="like-group" style="line-height:20px !important;" id="myStyle_sub_profile_mb_<?php echo $sr_no; ?>"></span>
                                                                        <?php
                                                                        }
                                                                    } else { ?>
                                                                        <span class="like-group" style="line-height:20px !important;" id="other_dis_sub_profile_mb_<?php echo $sr_no; ?>">
                                                                            ...
                                                                            ?>
                                                                            <a href="<?php echo SERVER_ROOTPATH; ?>process/detail_profile?user=<?php echo urlencode($user_name); ?>&critaria=1" data-toggle="modal" data-target="#missing_popular_review_Modal2_<?php echo $sr_no; ?>" data-title="" class="like link-disable" style="color:#fff; font-size:12px;"> <?php echo $counter_main; ?></a></span>
                                                                        <span class="like-group" style="line-height:20px !important;" id="myStyle_sub_profile_mb_<?php echo $sr_no; ?>"></span>
...
<div class="modal fade" id="report_edit_success" tabindex="-1" role="dialog" aria-labelledby="basicModal">
    <div class="modal-dialog" style="margin-top:10%;">
        <div class="modal-content" style="border-radius:0px;">
            <div class="modal-header">
                <h4 class="modal-title" style="color:#3276b1;"> Thank you for updating your review <img data-dismiss="modal" onclick="close_popup()" style="cursor:pointer; float:right;" src="https://www.tailem.com/images/xcrosspng.png.pagespeed.ic.x-7sR0qk1S.webp" data-pagespeed-url-hash="3119113509" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                </h4>
            </div>
            <div class="modal-body" style="overflow-y:auto; min-height:250px;">
                <p>
