...
<section class="middle_sec">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            value="<?php echo stripslashes(session()->get('main_search')); ?>"
                            id="search" name="search" placeholder="Search for an Artist, Album or Song" required>
                        <!--<button type="submit" type="submit" name="submit_ba" id="submit_ba" class="btn">Submit</button>-->


                        <button class="btn" type="submit" value="Search" name="submitbtn"><i
    ...
    <div class="topsonglistsec" style="padding:0;">
        <div class="container"
            style="padding:0; <?php if ($mobile_view == 1) { ?> margin-right:0; <?php } else { ?> <?php } ?>">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <div class="brows-label-penel" style="background-color:#FFFFFF;">
                            <ul class="list-inline">
                                <li>
                                    <a class="active"
                                        href="<?php echo SERVER_ROOTPATH; ?>searcher">ALL
                                        RESULTS</a> |
                                    <a
                                        href="<?php echo SERVER_ROOTPATH; ?>searcher-results-song">SONGS</a>
                                    |
                                    <a
                                        href="<?php echo SERVER_ROOTPATH; ?>searcher-results-artist">ARTISTS</a>
                                    |
                                    <a
                                        href="<?php echo SERVER_ROOTPATH; ?>searcher-results-album">ALBUMS</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="brows-label-penel search_bread_crumb">
                        <div class="row">
                            ...
                            <div class="col-xs-6 search_see_all">
                                <ul class="list-inline">
                                    <li><a href="<?php echo SERVER_ROOTPATH; ?>searcher-results-song"
                                            aria-controls="song" class="active">See All</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row mobileview0">
                                ...
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                        ...
                                        <a href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"
                                            class="text_blck"> <?php
                                                                                                                                                                    if ($picture != "") {
                                                                                                                                                                        ...
                                                                                                                                                                        if ($img_api_linka != '') {
                                                                                                                                                                            ?>
                                            <img src="<?php echo album_img_api($picture); ?>"
                                                border="0" width="120" />
                                            <?php
                                                                                                                                                                        } else { ?>
                                            ...
                                            <?php
                                                                                                                                                                        ...
                                                                                                                                                                        ?>
                                            <img src="<?php echo album_img_api($req_song['song_array']['image4']); ?>"
                                                border="0" width="120" />
                                            <?php
                                    ...
                                    <div class="album_details" style="margin-top:0; padding: 2% 0 0 4%;">
                                        ...
                                        <label class="review_screen_txt title" style="margin-bottom:5px;"><a
                                                href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"><?php echo substr($song_title, 0, 45);
                                                                                                                                                                                                                    if (strlen($song_title) > 45) {
                                                                                                                                                                                                                        echo "...";
                                                                                                                                                                                                                    } ?>
                                            </a></label>

                                        <label class="review_ipad_txt title" style="margin-bottom:5px;"><a
                                                href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"><?php echo substr($song_title, 0, 32);
                                        ...
                                        <label class="author"><a
                                                href="<?php echo SERVER_ROOTPATH . Slug($artist_seo) . "/artist-songs"; ?>"><?php echo substr($artist_name, 0, 32);
                                        ...
                                        <label class="likes" style="float:right; height:26px; margin-top:-9px;">
                                            ...
                                            <span style="overflow:visible;"
                                                id="other_dis_sub_<?php echo $sr_no; ?>_<?php echo $db_art_id; ?>"><a
                                                    href="javascript:;"
                                                    onClick="add_in_favourite_list_sub_artist_new('<?php echo $db_art_id; ?>','<?php echo $sr_no; ?>','<?php echo $artist_seo; ?>','<?php echo $k_song; ?>')"
                                                    class="text_grey"><i class="fa fa-heart-o"
                                                        style="font-size:24px; color:#D73B3B;"></i> </a><span
                                                    class="text_red"><?php echo $counter_main; ?></span><a
                                            ...
                                            <span style="overflow:visible;  display:none;"
                                                id="myStyle_sub_<?php echo $sr_no; ?>_<?php echo $db_art_id; ?>"></span>
                                            <?php
                                                            } else { ?>
                                            <span style="overflow:visible;"
                                                id="other_dis_sub_<?php echo $sr_no; ?>_<?php echo $db_art_id; ?>"><a
                                            ...
                                            <?php
                                                            ...
                                                            ?>
                                            <span style="overflow:visible;"
                                                id="other_dis_sub_<?php echo $sr_no; ?>_<?php echo $db_art_id; ?>">
                                                <?php
                                                                if ($user_id == "") {
                                                                    ?>
                                                ...
                                                <span class="text_red"><?php echo $counter_main; ?></span><a
                                                    href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_seo; ?>&critaria=1"
                                                    data-toggle="modal" data-target="#artist_modal" data-title=""
                                                    class="like link-disable" style="color:#444;"><?php if ($counter_main < 2) {
                                                                    echo " Like";
...
images/icon_post.png"><a>Posts <span><?php echo $comment_list_arr['count_discussion']; ?></span></a></label>
                                    ...
                                    <a class="playlist_icon" data-title="" data-target="#show_playlist"
                                        data-toggle="modal"
                                        href="<?php echo SERVER_ROOTPATH; ?>add-playlist?song_id=<?php echo $id; ?>&art_id=<?php echo $db_art_id; ?>"><img
                                            src="<?php echo addtoplaylist_icon(); ?>"
                                            title="Add to Playlist" /></a>
                                    <?php
                                                }
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-right:2px !important;">
                                    ...
                                    <div class="album_cover">
                                        <a href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"
                                            class="text_blck"> <?php
                                                                                                                                                                        if ($picture != "") {
                                                                                                                                                                            ...
                                                                                                                                                                            if ($img_api_linka != '') {
                                                                                                                                                                                ?>
                                            <img src="<?php echo album_img_api($picture); ?>"
                                                border="0" class="fixed-hgt-img"
                                                style="max-width:inherit; height:80px !important;" />
                                            <?php
                                                                                                                                                                            } else { ?>
                                            <img src="<?php echo SERVER_ROOTPATH; ?>site_upload/song_images/<?php echo 'thumb_' . $picture; ?>"
                                                class="fixed-hgt-img" border="0" />
                                            <?php
                                                                                                                                                                            }
                                                                                                                                                                        } elseif ($req_song['song_array']['image4'] != "") {
                                                                                                                                                                            ?>
                                            <img src="<?php echo album_img_api($req_song['song_array']['image4']); ?>"
                                                class="img-responsive" border="0" style="max-width:inherit; " />
                                            <?php
                                                                                                                                                                        } elseif ($album_picture != "") {
                                                                                                                                                                            ?>
                                            <img src="<?php echo SERVER_ROOTPATH; ?>site_upload/album_images/<?php echo 'thumb_' . $album_picture; ?>"
                                            ...
                                            <?php
                                                                                                                                                                            ...
                                                                                                                                                                            ?>
                                            <img src="<?php echo SERVER_ROOTPATH; ?>assets/images/no_image4.png"
                                                class="fixed-hgt-img" border="0" style="max-width:inherit; " />
                                            <?php
                                                                                                                                                                        }
                                                            ?>
                                        </a>
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 album-detail-container"
                                    ...
                                    <div class="album_details" style="margin-top:0;">
                                        <label class="title"><a
                                                href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"><?php echo substr($song_title, 0, 22);
                                                                                                                                                                            if (strlen($song_title) > 22) {
                                                                                                                                                                                echo "...";
                                                                                                                                                                            } ?>
                                            </a></label>
                                        <label class="author"><a
                                                href="<?php echo SERVER_ROOTPATH . Slug($artist_seo) . "/artist-songs"; ?>"><?php echo substr($artist_name, 0, 20);
                                        ...
                                        <p><label class="reviews"><img src="images/review-book.png"><a>Reviews <span>
                                                        <?php echo $review_list_arr_top['count_reviews']; ?></span></a></label><label
...
images/icon_post.png"><a><?php if ($comment_list_arr['count_discussion'] < 2) {
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-right:0">
                                    <div class="col-sm-5 col-xs-5">
                                        ...
                                        <a data-title="" data-target="#show_playlist" data-toggle="modal"
                                            href="<?php echo SERVER_ROOTPATH; ?>add-playlist?song_id=<?php echo $id; ?>&art_id=<?php echo $db_art_id; ?>"
                                            style="padding:0; float:left; margin-right:6px;"><img
                                                src="<?php echo addtoplaylist_icon(); ?>"
                                                title="Add to Playlist" /></a>
                                        <?php
                ...
                <div class="brows-label-penel search_bread_crumb_bottom">
                    <div class="row">
                        ...
                        <div class="col-xs-6 search_see_all">
                            <ul class="list-inline">
                                <li><a class="active"
                                        href="<?php echo SERVER_ROOTPATH; ?>searcher-results-artist"
                                        aria-controls="artist">See All</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <li>
                        ...
                        <div class="row mobileview0">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-11 col-xs-12">
                                <div class="album_cover">
                                    ...
                                    <a
                                        href="<?php echo SERVER_ROOTPATH . Slug($artist_seo) . "/artist-songs"; ?>"><img
                                            src="<?php echo get_small_thumb($artist_img); ?>"
                                            border="0" width="120"
                                ...
                                <div class="album_details" style="margin-top:0; padding: 2% 0 0 4%;">
                                    <!--Desktop-->
                                    <label class="review_screen_txt title"><a
                                            href="<?php echo SERVER_ROOTPATH . Slug($artist_seo) . "/artist-songs"; ?>"><?php echo substr($artist_name, 0, 50);
                                                                                                                                                                            if (strlen($artist_name) > 50) {
                                                                                                                                                                                echo "...";
                                                                                                                                                                            } ?>
                                        </a></label>
                                    <!-- Ipad-->
                                    <label class="review_ipad_txt title"><a
                                            href="<?php echo SERVER_ROOTPATH . Slug($artist_seo) . "/artist-songs"; ?>"><?php echo substr($artist_name, 0, 20);
                                                                                                                                                                        if (strlen($artist_name) > 20) {
                                                                                                                                                                            echo "...";
                                                                                                                                                                        } ?>
                                    ...
                                    <label class="likes">
                                        ...
                                        <span style="overflow:visible;"
                                            id="other_dis_sub_<?php echo $id; ?>"><a
                                                href="javascript:;"
                                                onClick="add_in_favourite_list_sub('<?php echo $id; ?>','<?php echo $artist_seo; ?>','<?php echo $k_artist; ?>')"><i
                                        ...
                                        <span style="overflow:visible;"
                                            id="other_dis_sub_<?php echo $id; ?>"><a
                                                href="javascript:;"
                                                onClick="add_in_favourite_list_sub('<?php echo $id; ?>','<?php echo $artist_seo; ?>','<?php echo $k_artist; ?>')"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 album-outer-coontainer"
                                ...
                                <div class="album_cover">
                                    ...
                                    <a
                                        href="<?php echo SERVER_ROOTPATH . Slug($artist_seo) . "/artist-songs"; ?>"><img
                                            src="<?php echo $req_artist['artist_array']['image4']; ?>"
            ...
            <div class="brows-label-penel search_bread_crumb_bottom">
                <div class="row">
                    ...
                    <div class="col-xs-6 search_see_all">
                        <ul class="list-inline">
                            <li><a href="<?php echo SERVER_ROOTPATH; ?>searcher-results-album"
                                    aria-controls="album" class="active">See All</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <ul class="songlistings">
                ...
                <li>
                    ...
                    <div class="row mobileview0">
                        ...
                        <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                            <div class="album_cover">
                                <a href="<?php echo SERVER_ROOTPATH . $artist_seo . "/album/" . $album_seo; ?>"
                                    class="text_grey"><?php
                                                                                                                                                        if ($album_picture != "") {
                                    ...
                                    <?php
                                                                                                                                                            ...
                                                                                                                                                            if ($req_artist['album_array']['image4'] != "") {
                                                                                                                                                                ?>
                                    <img src="<?php echo $req_artist['album_array']['image4']; ?>"
                                        border="0" width="120" />
                                    <?php
                                                                                                                                                            } else {
                                                                                                                                                                ?>
                            ...
                            <div class="album_details" style="margin-top:0; padding: 2% 0 0 4%;">
                                <!--Desktop-->
                                <label class="review_screen_txt title" style="margin-bottom:5px;"><a
                                        href="<?php echo SERVER_ROOTPATH . $artist_seo . "/album/" . $album_seo; ?>"><?php echo substr($album_title, 0, 50);
                                ...
                                <!--Ipad-->
                                <label class="review_ipad_txt title" style="margin-bottom:5px;"><a
                                        href="<?php echo SERVER_ROOTPATH . $artist_seo . "/album/" . $album_seo; ?>"><?php echo substr($album_title, 0, 14);
                                ...
                                <div>
                                    <label class="author" style=" float:left;"><?php
                                                                                                    if ($various['artist_name'] != "") {
                                                                                                        ?>
                                        <a
                                            href="<?php echo SERVER_ROOTPATH . Slug($various['artist_seo']) . "/artist-songs"; ?>"><?php echo substr($various['artist_name'], 0, 32);
                                    ...
                                    <label class="likes" style="margin-top:-9px;">
                                        <?php
                                                            if ($user_id != "") {
                                                                ...
                                                                if ($counter == 0) {
                                                                    ?>
                                        <span style="overflow:visible;"
                                            id="other_dis_sub_<?php echo $db_art_id; ?>"><a
                                                href="javascript:;"
                                                onClick="add_in_favourite_list_sub('<?php echo $db_art_id; ?>','<?php echo $artist_seo; ?>','<?php echo $k_album; ?>')"
                                                class="text_grey"><i class="fa fa-heart-o heart_size heart_color"></i>
                                            </a><span class="text_red"><?php echo $counter_main; ?></span><a
                                                href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_seo; ?>&critaria=1"
                                                data-toggle="modal" data-target="#artist_modal" data-title=""
                                                class="like link-disable" style="color:#444;"><?php if ($counter_main < 2) {
                                                                        echo " Like";
                                        ...
                                        <span style="overflow:visible;  display:none;"
                                            id="myStyle_sub_<?php echo $db_art_id; ?>"></span>
                                        ...
                                        <span style="overflow:visible;"
                                            id="other_dis_sub_<?php echo $db_art_id; ?>"><a
                                                href="javascript:;"
                                                onClick="add_in_favourite_list_sub('<?php echo $db_art_id; ?>','<?php echo $artist_seo; ?>','<?php echo $k_album; ?>')"
                                                class="like link-disable"><i
                                                    class="fa fa-heart heart_color heart_size"></i></a> <span
                                                class="text_red"><?php echo $counter_main; ?></span><a
                                                href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_seo; ?>&critaria=1"
                                                data-toggle="modal" data-target="#artist_modal" data-title=""
                                                class="like link-disable" style="color:#444;"><?php if ($counter_main < 2) {
                                        ...
                                        <span style="overflow:visible;"
                                            id="other_dis_sub_<?php echo $db_art_id; ?>">
                                            <?php
                                                                    if ($user_id == "") {
                                                                        ?>
                                            <a href="#" data-toggle="modal" data-target="#signin_form"><i
                                            ...
                                            <a href="javascript:;"
                                                onClick="add_in_favourite_list_sub('<?php echo $db_art_id; ?>','<?php echo $artist_seo; ?>','<?php echo $k_album; ?>')"
                                                class="text_grey"><i
                                                    class="fa fa-heart-o heart_size heart_color"></i></a>
                                            <?php
                                                                    }
                                                                    ?>
                                            <span class="text_red"><?php echo $counter_main; ?></span><a
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 album-detail-container"
                            ...
                            <div class="album_details" style="margin-top:0;">
                                <label class="title"><a
                                        href="<?php echo SERVER_ROOTPATH . $artist_seo . "/album/" . $album_seo; ?>"><?php echo substr($album_title, 0, 32);
                                ...
                                <label class="likes" style="float:left; height:26px;">
                                    ...
                                    <span style="overflow:visible;"
                                        ...
                                        <a href="javascript:;"
                                            onClick="add_in_favourite_list_sub('<?php echo $db_art_id; ?>','<?php echo $artist_seo; ?>','<?php echo $k_album; ?>')"
                                            class="text_grey"><i class="fa fa-heart-o heart_size heart_color"></i></a>
                                        <?php
                                                                    }
                                                                    ?>
                                        <span class="text_red"><?php echo $counter_main; ?></span><a
