                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <div class="brows-label-penel" style="background-color:#FFFFFF;">
                            <ul class="list-inline">
                                <li>
                                    <a class="active" href="<?php echo SERVER_ROOTPATH; ?>searcher">ALL RESULTS</a> |
                ...
                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="brows-label-penel search_bread_crumb">
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <ul class="list-inline">
                                    <li>SONGS <span class="active">(<?php echo $song_count; ?>)</span></li>
                                </ul>
                            </div>
                                        ...
                                        <div class="row mobileview0">
                                            ...
                                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                                ...
                                                <div class="album_details" style="margin-top:0; padding: 2% 0 0 4%;">
                                                    ...
                                                    <label class="review_ipad_txt title" style="margin-bottom:5px;"><a href="<?php echo SERVER_ROOTPATH . $song_seo . "/reviews/" . $artist_seo; ?>"><?php echo substr($song_title, 0, 32);
                                                                                                                                                                                                        if (strlen($song_title) > 32) {
                                                                                                                                                                                                            echo "...";
                                                                                                                                                                                                        } ?></a></label>

                                                    <label class="author"><a href="<?php echo SERVER_ROOTPATH . $artist_seo . "/artist-songs"; ?>"><?php echo substr($artist_name, 0, 32);
                                                    ...
                                                    if ($feature_artists != "") { ?>
                                                        ...
                                                        <p><label class="reviews">ft. <?php echo $feature_artists; ?></label></p> <?php } ?> <div style="clear:both;"></div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-right:2px !important;">
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 album-outer-coontainer" style="padding:0px !important;">
													...
													if ($album_picture != "") {
                                                        ...
                                                        <div style="position:inherit; z-index:10; float:right; color:#FFFFFF; margin-top:-20px; margin-right:3px;"><?php echo $k_song; ?></div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 album-detail-container" style="padding:0px !important;">
                                                    <div class="album_details" style="margin-top:0;">
                                                        <label class="title"><a href="<?php echo SERVER_ROOTPATH . $song_seo . "/reviews/" . $artist_seo; ?>"><?php echo substr($song_title, 0, 22);
                                                        ...
                                                        if ($feature_artists != "") { ?>
                                                            ...
                                                            <p><label class="reviews" style="float:left;">ft. <?php echo $feature_artists; ?></label></p> <?php } ?> <div style="clear:both;"></div>
                                                        ...
                                                        <p><label class="reviews"><img src="static/images/review-book.png"><a>Reviews <span> <?php echo $review_list_arr_top['count_reviews']; ?></span></a></label><label class="reviews"><img src="static/images/icon_post.png"><a><?php if ($comment_list_arr['count_discussion'] < 2) {
                                                                                                                                                                                                                                                                                            echo "Posts ";
                                                                                                                                                                                                                                                                                        } else {
                                                                                                                                                                                                                                                                                            echo "Posts ";
                    ...
                    <div class="brows-label-penel search_bread_crumb_bottom">
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <ul class="list-inline">
                                    <li>ARTISTS <span class="active">(<?php echo $artist_count; ?>)</span></li>
                                </ul>
                            </div>
                            <div class="col-xs-6 search_see_all">
                                <ul class="list-inline">
                                            ...
                                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                                <div class="album_cover">
                                                    ...
                                                    if ($artist_img != "") {
                                                        ...
                                                        if ($img_api_linka != '') { ?>
                                                            <a href="<?php echo SERVER_ROOTPATH . $artist_seo . "/artist-songs"; ?>"><img src="<?php echo get_small_thumb($artist_img); ?>" border="0" width="120" title="<?php echo $artist_name; ?>" /></a>
                                                        <?php } else { ?>
                                                            <a href="<?php echo SERVER_ROOTPATH . $artist_seo . "/artist-songs"; ?>"><img src="<?php echo SERVER_ROOTPATH; ?>site_upload/artist_images/<?php echo '' . $artist_img; ?>" border="0" width="120" title="<?php echo $artist_name; ?>" /></a>
                                                        <?php
                                                        }
                                                    } else
											if ($artist_img == "") {
                                                        ...
                                                        ?>
                                                            <a href="<?php echo SERVER_ROOTPATH . $artist_seo . "/artist-songs"; ?>"><img src="<?php echo SERVER_ROOTPATH; ?>assets/images/no_image4.png" border="0" width="120" title="<?php echo $artist_name; ?>" /></a>
                                                    <?php
                                                        }
                                                    }
                                                    ?>
                                                ...
                                                <div class="album_details" style="margin-top:0; padding: 2% 0 0 4%;">
                                                    <!--Desktop-->
                                                    <label class="review_screen_txt title"><a href="<?php echo SERVER_ROOTPATH . $artist_seo . "/artist-songs"; ?>"><?php echo substr($artist_name, 0, 50);
                                                                                                                                                                    if (strlen($artist_name) > 50) {
                                                                                                                                                                        echo "...";
                                                                                                                                                                    } ?></a></label>
                                                    <!-- Ipad-->
                                                    <label class="review_ipad_txt title"><a href="<?php echo SERVER_ROOTPATH . $artist_seo . "/artist-songs"; ?>"><?php echo substr($artist_name, 0, 20);
                                                                                                                                                                    if (strlen($artist_name) > 20) {
                                                                                                                                                                        echo "...";
                                                                                                                                                                    } ?></a></label>
                                    ...
                                    <?php } else if ($mobile_view == 1) { ?>
                                        ...
                                        <div class="row mobileview1">
 										...
 										<span class="list_no"><?php if (strlen($k_artist) == 1) {
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 album-outer-coontainer" style="padding:0px !important;">
                                                    <div class="album_cover">
                                                        ...
                                                        if ($artist_img != "") {
                                                            ...
                                                            <?php } else { ?>
                                                                <a href="<?php echo SERVER_ROOTPATH . $artist_seo . "/artist-songs"; ?>"><img src="<?php echo SERVER_ROOTPATH; ?>site_upload/artist_images/<?php echo 'thumb_' . $artist_img; ?>" border="0" width="120" /></a>
											...
											if ($req_artist) {
                                                            ?>
                                                            <a href="<?php echo SERVER_ROOTPATH . $artist_seo . "/artist-songs"; ?>"><img src="<?php echo $req_artist['artist_array']['image4']; ?>" border="0" width="100" /></a>
                                                        <?php
                                                        } else {
                                                        ?>
                                                        ...
                                                        <div style="position:inherit; z-index:10; float:right; color:#FFFFFF; margin-top:-20px; margin-right:3px;"><?php echo $k_artist; ?></div>

                                                    </div>
                                                </div>
                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 album-detail-container" style="padding:0px !important;">
                                                    <div class="album_details" style="margin-top:0;">
                                                        <label class="title"><a href="<?php echo SERVER_ROOTPATH . $artist_seo . "/artist-songs"; ?>"><?php echo substr($artist_name, 0, 20);
                                                                                                                                                        if (strlen($artist_name) > 20) {
                                                                                                                                                            echo "...";
                                                ...
                                                <div class="album_details" style="margin-top:0; padding: 2% 0 0 4%;">
                                                    ...
                                                    <div>
                                                        <label class="author" style="width:200px; float:left;"><?php
                                                                                                                ...
                                                                                                                ?>
                                                                <a href="<?php echo SERVER_ROOTPATH . $various['artist_seo'] . "/artist-songs"; ?>"><?php echo substr($various['artist_name'], 0, 32);
                                                            ...
                                                            ?> <a href="<?php echo SERVER_ROOTPATH . $artist_seo . "/artist-songs"; ?>"><?php echo substr($artist_name, 0, 32);
                                                                                                                                        if (strlen($artist_name) > 32) {
                                                                                                                                            echo "...";
                                                                                                                                        } ?><?php //echo $artist_name;
                                                                                                                                            ?></a>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 album-outer-coontainer" style="padding:0px !important;">
													...
													if ($album_picture == "") {
                                                        ...
                                                        ?><cite style="background-color:<?php echo $color_pick; ?>"><?php if ($all_avg < 10) {
                                                            ...
                                                            <cite style="background-color:#dd554e">0.0</cite>
                                                        <?php } ?>
                                                        <div style="position:inherit; z-index:10; float:right; color:#FFFFFF; margin-top:-20px; margin-right:3px;"><?php echo $k_album; ?></div>
