        ...
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                <div class="account-wall">
                    <h4 class="account_hd"> You can update social icons here </h4>
                    <form class="form-social-icon form-signin">
                        <div class="error" style="display:none;margin-bottom:11px;"></div>
                        @csrf

                        <select name="icon_type" id="icon-type" style="margin-bottom: 10px;" class="form-control" onchange="icon_change_div(this.value)">
                        ...
                        <input type="text" name="icon_link" class="form-control" placeholder="Please profile link">
                        <input type="file" name="icon_image" class="form-control">
                        <input type="hidden" name="user_id" value="<?php echo session()->get('user_id') ?>" class="form-control">




                        <button style="margin-top:10px;" class="btn btn-lg btn-primary btn-block" type="submit" name="submit_btn" id="submit_btn" value="Submit">Update Social Icon</button>
                    </form>
                </div>
        ...
        $.ajax({
            ...
            success: function(res) {
                switch (res.code) {
                    case 'success':
                        alert(res.message);
                        window.location.href = "<?php echo SERVER_ROOTPATH.'review-artist' ?>";
