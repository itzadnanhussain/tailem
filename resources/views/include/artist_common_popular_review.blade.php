...
<div class="recentreviewsec rev_position recent_style rev_right_position" style="margin-top:30px !important;">
    ...
    <?php
    $popular_review_array = artist_popular_review_data($artist_id_db);
    ...
    if ($popular_review_array) {
        ...
        foreach ($popular_review_array as $val) {
            ...
            if ($all_avg >= 7) {
                $color_pick_all = "#5ebd5e";
            } elseif ($all_avg >= 4 && $all_avg <= 6.9) {
                $color_pick_all = "#e06d21";
            } elseif ($all_avg >= 0 && $all_avg <= 3.9) {
                $color_pick_all = "#dd554e";
            }
            ...
            if ($review_rating >= 7) {
                $color_pick = "#5ebd5e";
            } elseif ($review_rating >= 4 && $review_rating <= 6.9) {
                $color_pick = "#e06d21";
            } elseif ($review_rating >= 0 && $review_rating <= 3.9) {
                $color_pick = "#dd554e";
            }
    ...
    ?>
            ...
            <div class="review_item">
                <div class="album_cover">
                    <div class="bottom_sec rev_top_val">
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 txtalnright" style="padding-right:10px;">
                                <?php
                                if ($all_avg != 0) {
                                ?><cite class="lightorange" style="background-color:<?php echo $color_pick_all; ?>"><?php if ($all_avg < 10) {
                                                                                                                        echo number_format($all_avg, 1);
                                                                                                                    } else {
                                                                                                                        echo $all_avg;
                                                                                                                    } ?></cite><?php } else { ?> <cite class="lightorange">5.0</cite><?php } ?>
                            </div>
                        </div>
                    </div>
                    <!--<img src="images/reviewitem1.png">-->
                    <?php
                    if ($picture != "") {
                        ...
                        if ($img_api_link != '') {
                    ?>
                            <img src="<?php echo $img_api_link; ?>" border="0" class="img-responsive" style="width:100%; max-height:350px;" />
                        <?php } else { ?>
                    ...
                    ?>
                    <!--<cite class="lightorange">5.0</cite>-->
                    ...
                    <div class="bottom_sec" style="padding-bottom:0;">
                        <div class="row">
                            ...
                            <div class="review_screen_txt col-lg-9 col-md-8 col-sm-8 col-xs-8 pad_right">
                                <label class="mrg_btm font_wgt"><a href="<?php echo SERVER_ROOTPATH . "song-detail/" . $song_seo . "-reviews-" . $artist_seo; ?>" style="font-size: 16px; color: #fff; font-family: 'Montserrat', sans-serif; font-weight:normal;"><?php echo substr($song_title, 0, $screen_chr);
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-4 pad_zero">
                                <span style="float:right; margin-right:8px;" class="like-group">
                                    ...
                                    if ($user_id != "") {
                                        ...
                                        if ($counter == 0) {
                                    ?>
                                            <span id="other_dis_sub_popular_<?php echo $p_fav; ?>_<?php echo $artist_id; ?>"><a href="javascript:;" onClick="add_in_favourite_list_sub_artist_pop('<?php echo $artist_id; ?>','<?php echo $p_fav; ?>','<?php echo $artist_seo; ?>','<?php echo $p_fav; ?>')"><i class="fa fa-heart-o" style="font-size:24px; color:#c63937;"></i></a> <?php echo $counter_main; ?><a href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_seo; ?>&critaria=1" data-toggle="modal" data-target="#artist_modal" data-title="" style="color:#fff;"> <?php if ($counter_main < 2) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo " Like";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        } else {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo " Likes";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        } ?></a></span>
                                            <span id="myStyle_sub_popular_<?php echo $p_fav; ?>_<?php echo $artist_id; ?>"></span>

                                        <?php
                                        } else {
                                        ?>
                                            <span id="other_dis_sub_popular_<?php echo $p_fav; ?>_<?php echo $artist_id; ?>"><a href="javascript:;" onClick="add_in_favourite_list_sub_artist_pop('<?php echo $artist_id; ?>','<?php echo $p_fav; ?>','<?php echo $artist_seo; ?>','<?php echo $p_fav; ?>')" style="color:red"><i class="fa fa-heart" style="font-size:24px; color:#c63937;"></i></a> <?php echo $counter_main; ?><a href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_seo; ?>&critaria=1" data-toggle="modal" data-target="#artist_modal" data-title="" style="color:#fff;"> <?php if ($counter_main < 2) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo " Like";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        } else {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo " Likes";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        } ?></a></span>
                                        ...
                                        ?>
                                        <span id="other_dis_sub_popular_<?php echo $p_fav; ?>_<?php echo $artist_id; ?>">
                                            <?php
                                            if ($user_id == "") {
                                            ?>
                                                <a href="#" data-toggle="modal" data-target="#signin_form" class="text_grey"><i class="fa fa-heart-o" style="font-size:24px; color:#c63937;"></i> </a>
                                            <?php
                                            } else {
                                            ?>
                                                <a href="javascript:;" onClick="add_in_favourite_list_sub_artist_pop('<?php echo $artist_id; ?>','<?php echo $p_fav; ?>','<?php echo $artist_seo; ?>','<?php echo $p_fav; ?>')" class="text_grey"><i class="fa fa-heart-o" style="font-size:24px; color:#c63937;"></i> </a>
                                            <?php
                                            }
                                            ?>
                                            <a href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_seo; ?>&critaria=1" data-toggle="modal" data-target="#artist_modal" data-title="" style="color:#fff;"> <?php echo $counter_main; ?> <?php if ($counter_main < 2) {
                                                                                                                                                                                                                                                                echo "Like";
                                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                                echo "Likes";
                                                                                                                                                                                                                                                            } ?></a></span>
                ...
                <div class="album_detail">
                    <!--Desktop-->
                    <p class="review_screen_txt" style="margin-top:5px; margin-bottom:4px;"><label><a class="rec_review_title" href="<?php echo SERVER_ROOTPATH . "song-detail/" . $song_seo . "-reviews-" . $artist_seo . "#review_" . $review_id; ?>"><?php echo substr($review_title, 0, $screen_rev);
                    ...
                    <!--Ipad-->
                    <p class="review_ipad_txt" style="margin-top:5px; margin-bottom:4px;"><label><a class="rec_review_title" href="<?php echo SERVER_ROOTPATH . "song-detail/" . $song_seo . "-reviews-" . $artist_seo . "#review_" . $review_id; ?>"><?php echo substr($review_title, 0, $ipad_rev);
                    ...
                    <!--Mobile-->
                    <p class="review_mobile_txt" style="margin-top:5px; margin-bottom:4px;"><label><a class="rec_review_title" href="<?php echo SERVER_ROOTPATH . "song-detail/" . $song_seo . "-reviews-" . $artist_seo . "#review_" . $review_id; ?>"><?php echo substr($review_title, 0, $mobile_rev);
                    ...
                    <p style="margin-bottom:16px;"><span style="white-space:normal;"><a class="review_detail darkgrey_rev" href="<?php echo SERVER_ROOTPATH . "song-detail/" . $song_seo . "-reviews-" . $artist_seo . "#review_" . $review_id; ?>"><?php
                                                                                                                                                                                                                                                    $detail_rev  = substr($review_detail, 0, 128);
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="text-align:right; padding-left:0;">
                            <!--<span class="usrdetails"><i class="fa fa-heart-o" style="font-size:24px; color:#D73B3B;" ></i> 0 <a href="#"> Likes</a></span>-->
                            <?php
                            ...
                            if ($user_id != "") {
                                ...
                                if ($counter == 0) { ?>
                                    ...
                                    if ($review_user_id == $user_id) { ?>
                                        <span class="darkgrey_rev" id="other_dis_sub_<?php echo $db_review_id; ?>"><a href="javascript:;" title="your own review"><i class="fa fa-heart-o" style="font-size:24px; color:#D73B3B;"></i></a> <?php echo $counter_main;
                                                                                                                                                                                                                                        } else { ?>
                                            ...
                                            <a href="detail_review.php?user=<?php echo urlencode($user_name); ?>&review_id=<?php echo $db_review_id; ?>&critaria=1" data-toggle="modal" data-target="#review_modal" data-title="" class="like darkgrey_rev"> <?php if ($counter_main < 2) {
                                                                                                                                                                                                                                                                    echo " Like";
                                                                                                                                                                                                                                                                } else {
                                                                                                                                                                                                                                                                    echo " Likes";
                                                                                                                                                                                                                                                                } ?></a></span>
                                        ...
                                        <?php
                                            ...
                                            <span class="darkgrey_rev" id="other_dis_sub_<?php echo $db_review_id; ?>"><a href="javascript:;" onClick="add_in_favourite_list_review_song('<?php echo $db_review_id; ?>','<?php echo $user_name; ?>','<?php echo $r_fav; ?>')" class="like"><i class="fa fa-heart" style="font-size:24px; color:#D73B3B;"></i></a> <?php echo $counter_main; ?><a href="detail_review.php?user=<?php echo urlencode($user_name); ?>&review_id=<?php echo $db_review_id; ?>&critaria=1" data-toggle="modal" data-target="#review_modal" data-title="" class="like darkgrey_rev"> <?php if ($counter_main < 2) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    echo " Like";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                } else {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    echo " Likes";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                } ?></a></span>
                                        ...
                                        <span class="darkgrey_rev" id="other_dis_sub_<?php echo $db_review_id; ?>">
                                            ...
                                            ?>
                                                <a href="javascript:;" onClick="add_in_favourite_list_review_song('<?php echo $db_review_id; ?>','<?php echo $user_name; ?>','<?php echo $r_fav; ?>')"><i class="fa fa-heart-o" style="font-size:24px; color:#D73B3B;"></i></a>
                                            <?php
                                            }
                                            ?>
                                            <?php echo $counter_main; ?><a href="detail_review.php?user=<?php echo urlencode($user_name); ?>&review_id=<?php echo $db_review_id; ?>&critaria=1" data-toggle="modal" data-target="#review_modal" data-title="" class="like darkgrey_rev"> <?php if ($counter_main < 2) {
                                                                                                                                                                                                                                                                                                echo "Like";
                                                                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                                                                echo "Likes";
                                                                                                                                                                                                                                                                                            } ?></a></span>
