...
<a href="javascript:;"
    onClick="add_in_favourite_user_profile_screen_new('<?php echo $prod_id; ?>','<?php echo $sr_no; ?>','<?php echo $db_user_name; ?>')"
    class="like link-disable"><i class="fa fa-heart" style="font-size:20px; color:#d73b3b;"></i></a>
<a href="<?php echo SERVER_ROOTPATH; ?>detail_profile.php?user=<?php echo urlencode($db_user_name); ?>&critaria=1"
    data-toggle="modal" data-target="#profile_modal" data-title="" class="like link-disable"
    style="color:#fff;margin-left:2px;font-size:12px;"><?php echo $counter_main + 1; ?><?php //if($counter_main<2){ echo " Like";} else {  echo " Like"; }?></a>
...
<a href="javascript:;"
    onClick="add_in_favourite_user_profile_screen_new('<?php echo $prod_id; ?>','<?php echo $sr_no; ?>','<?php echo $db_user_name; ?>')"
    class="like link-disable"><i class="fa fa-heart-o" style="font-size:20px; color:#d73b3b;"></i></a>
<a href="<?php echo SERVER_ROOTPATH; ?>detail_profile.php?user=<?php echo urlencode($db_user_name); ?>&critaria=1"
    data-toggle="modal" data-target="#profile_modal" data-title="" class="like link-disable"
    style="color:#fff;margin-left:2px;font-size:12px;"><?php echo $counter_main - 1; ?><?php //if($counter_main<2){ echo " Like";} else {  echo " Like"; }?></a>
