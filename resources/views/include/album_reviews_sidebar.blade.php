    ...
    <div class="recentreviewsec rev_position">
        ...
        <div class="review_item">
            <div class="album_cover">
                <div class="bottom_sec rev_top_val">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 txtalnright" style="padding-right:10px;">
                            <?php if ($all_avg != 0) { ?>
                            <cite
                                style="background-color:<?php echo $color_pick_main; ?>"><?php if ($all_avg < 10) {
                    echo number_format($all_avg, 1);
                } else {
                    echo $all_avg;
                } ?>
                            </cite><?php } else { ?> <cite
                                style="background-color: red;">0.0</cite><?php } ?>
                        </div>
                    </div>
                </div>
                <?php
                ...
                <a
                    href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"><img
                        src="<?php echo $img_api_linka; ?>"
                        border="0" class="img-responsive" style="width:100%; " /></a>
                <?php } else {
                                ?>
                <a
                    href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"><img
                ...
                <a
                    ...
                    <img class="img-responsive"
                        src="<?php echo album_img_api($req_song['song_array']['image4']); ?>"
                ...
                <a
                    href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"><img
                        ...
                        border="0" class="img-responsive" style="max-width:inherit;" /></a>
                <?php
                        } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="review_screen_txt col-lg-9 col-md-8 col-sm-8 col-xs-8 pad_right">
                            <label class="mrg_btm font_wgt"><a
                                    href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"
                                    style="font-size: 16px; color: #fff; font-family: 'Montserrat', sans-serif; font-weight:normal;">
                                    <?php echo substr($song_title, 0, $screen_chr);
                    ...
                    echo "..";
                        ...
                        <div class="review_ipad_txt col-lg-9 col-md-9 col-sm-8 col-xs-8 pad_right">
                            <label class="mrg_btm font_wgt"><a
                                    href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"
                                    style="font-size: 16px; color: #fff; font-family: 'Montserrat', sans-serif; font-weight:normal;">
                                    <?php echo substr($song_title, 0, $ipad_chr);
                    ...
                    echo "..";
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-4 pad_zero">
                            <span style="float:right; margin-right:8px;" class="like-group">
                                ...
                                <span
                                    id="other_dis_sub_popular_<?php echo $artist_id; ?>_<?php echo $p_fav; ?>"><a
                                        href="javascript:;"
                                        onClick="like_artist_recent_reviews('<?php echo $artist_id; ?>','<?php echo $p_fav; ?>','<?php echo $artist_seo; ?>')"><i
                                            class="fa fa-heart-o heart_size heart_color"></i></a><a
                                        href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_id; ?>&critaria=1"
                                ...
                                <span
                                    id="myStyle_sub_popular_<?php echo $artist_id; ?>_<?php echo $p_fav; ?>"></span>
                                ...
                                <span
                                    id="other_dis_sub_popular_<?php echo $artist_id; ?>_<?php echo $p_fav; ?>"><a
                                        href="javascript:;"
                                        onClick="like_artist_recent_reviews('<?php echo $artist_id; ?>','<?php echo $p_fav; ?>','<?php echo $artist_seo; ?>')"><i
                                            class="fa fa-heart" style="color:#D73B3B; font-size:24px;"></i></a><a
                                        href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_id; ?>&critaria=1"
                                        data-toggle="modal" data-target="#artist_modal" data-title=""
                                        style="color:#fff;" class="link-disable"> <?php echo $counter_main; ?><?php if ($counter_main < 2) {
                                                    echo " Like";
                                                } else {
                                                    echo " Likes";
                                                } ?>
                                ...
                                <?php
                                            ...
                                            ?>
                                <span
                                    id="other_dis_sub_popular_<?php echo $artist_id; ?>_<?php echo $p_fav; ?>">
                                    <?php
                                                if ($user_id == "") {
                                                    ?>
                                    ...
                                    <a href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_id; ?>&critaria=1"
                                        data-toggle="modal" data-target="#artist_modal" data-title=""
                                        class="like link-disable" style="margin-left:4px; color:#FFFFFF;"> <?php echo $counter_main; ?><?php if ($counter_main < 2) {
                                                    echo " Like";
                                                } else {
                                                    echo " Likes";
                                                } ?>
            ...
            <div class="album_detail">
                <!--Desktop-->
                <p class="review_screen_txt" style="margin-top:5px; margin-bottom:4px;"><label><a
                            class="rec_review_title"
                            href="<?php echo SERVER_ROOTPATH . $song_seo . "/reviewslist/" . $artist_seo . "/" . $position_find . "#review_" . $review_id; ?>"><?php echo substr($review_title, 0, $screen_rev);
                ...
                <p class="review_ipad_txt" style="margin-top:5px; margin-bottom:4px;"><label><a class="rec_review_title"
                            href="<?php echo SERVER_ROOTPATH . $song_seo . "/reviewslist/" . $artist_seo . "/" . $position_find . "#review_" . $review_id; ?>"><?php echo substr($review_title, 0, $ipad_rev);
                ...
                <!--Mobile-->
                <p class="review_mobile_txt" style="margin-top:5px; margin-bottom:4px;"><label><a
                            class="rec_review_title"
                            href="<?php echo SERVER_ROOTPATH . $song_seo . "/reviewslist/" . $artist_seo . "/" . $position_find . "#review_" . $review_id; ?>"><?php echo substr($review_title, 0, $mobile_rev);
                ...
                <div class="row">
                    ...
                    <div class="review_screen_txt col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <span class="usrname"><img src="images/icon_user.png"><a class="darkgrey_rev"
                                href="<?php echo SERVER_ROOTPATH . get_user_detail($user_name) . "/profile-review-artist"; ?>"><?php echo substr($user_name, 0, 12);
                if (strlen($user_name) > 12) {
                    ...
                    <div class="review_ipad_txt white_space col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <span class="usrname"><img src="images/icon_user.png"><a class="darkgrey_rev"
                                href="<?php echo SERVER_ROOTPATH . get_user_detail($user_name) . "/profile-review-artist"; ?>"><?php echo substr($user_name, 0, 30);
                if (strlen($user_name) > 30) {
                    ...
                    <div class="review_mobile_txt col-lg-4 col-md-4 col-sm-8 col-xs-8">
                        <span class="usrname"><img src="images/icon_user.png"><a class="darkgrey_rev"
                                href="<?php echo SERVER_ROOTPATH . get_user_detail($user_name) . "/profile-review-artist"; ?>"><?php echo substr($user_name, 0, 16);
                        ...
                        if ($review_user_id == $user_id) {
                            ...
                            <span class="darkgrey_rev"
                                id="other_dis_sub_<?php echo $db_review_id; ?>"><a
                                    href="javascript:;" title="your own review"><i
                                        class="fa fa-heart-o heart_size heart_color text_grey"></i> </a><?php echo $counter_main;
                        } else {
                            ?>
                                <span class="darkgrey_rev"
                                    id="other_dis_sub_<?php echo $db_review_id; ?>"><a
                                    ...
                                    <a href="process/detail_review?user=<?php echo get_user_detail($user_name); ?>&review_id=<?php echo $db_review_id; ?>&critaria=1"
                            ...
                            echo " Likes";
                                ...
                                <span class="darkgrey_rev"
                                    id="other_dis_sub_<?php echo $db_review_id; ?>"><a
                                        ...
                                        class="like"><i class="fa fa-heart heart_size heart_color text_grey"></i></a>
                                    <?php echo $counter_main; ?><a
                                        href="process/detail_review?user=<?php echo get_user_detail($user_name); ?>&review_id=<?php echo $db_review_id; ?>&critaria=1"
                                        data-toggle="modal" data-target="#review_modal" data-title=""
                                        class="like link-disable darkgrey_rev"> <?php if ($counter_main < 2) {
                        echo "Like";
                    } else {
                                ...
                                <span class="darkgrey_rev"
                                    ...
                                    <?php
                                                    if ($user_id == "") {
                                                        ?>
                                    <a href="#" data-toggle="modal" data-target="#signin_form"><i
                                            class="fa fa-heart-o heart_size heart_color text_grey"></i></i></a>
                                    ...
                                    <a href="javascript:;"
                                        onClick="add_in_favourite_list_review_song('<?php echo $db_review_id; ?>','<?php echo $user_name; ?>','<?php echo $r_fav; ?>')"><i
                                            class="fa fa-heart-o heart_size heart_color text_grey"></i></a>
                                    <?php
                                                    } ?>
                                    <?php echo $counter_main; ?><a
                                        href="process/detail_review?user=<?php echo get_user_detail($user_name); ?>&review_id=<?php echo $db_review_id; ?>&critaria=1"
