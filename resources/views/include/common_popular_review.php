<?php include("common/recent_rev.php");  ?>
		...
		foreach($popular_review_array as $val)
		{
				...
				$review_title    = stripslashes(html_entity_decode($val['review_title']));
				  ...
				  $user_name = stripslashes(html_entity_decode($select_ar['user_name']));
					...
					if($all_avg >=7){$color_pick_main = "#5ebd5e";}
												if($all_avg >=4 && $all_avg <=6){$color_pick_main = "#e06d21";}
												if($all_avg >=0 && $all_avg <=3){$color_pick_main = "#dd554e";}
					...
					if($review_rating >=7){$color_pick = "#5ebd5e";}
					if($review_rating >=4 && $review_rating <=6){$color_pick = "#e06d21";}
					if($review_rating >=0 && $review_rating <=3){$color_pick = "#dd554e";}
		...
		?>
    						<div class="review_item">
								...
								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 txtalnright" style="padding-right:10px;">
									 <?php if($all_avg!=0){?>
                                    <cite style="background-color:<?php echo $color_pick_main;?>"><?php if($all_avg<10){echo number_format($all_avg,1);}else { echo $all_avg;}?></cite><?php } else { ?>   <cite style="background-color:#dd554e">0.0</cite><?php } ?>
								</div>
							</div>
                     			   </div>
 									<?php
                           ...
                           <!--Mobile-->     
								...
								<div class="col-lg-3 col-md-4 col-sm-4 col-xs-4 pad_zero">
										...
										<?php
                                            ...
                                            <a  href="<?php echo SERVER_ROOTPATH;?>like/detail?artist=<?php echo $artist_seo;?>&critaria=1" data-toggle="modal" data-target="#missing_popular_review_Modal2_5000" data-title="" class="link-disable" style="color:#fff;"> <?php echo $counter_main;?><?php if($counter_main<2){ echo " Like";} else {  echo " Likes"; }?></a>
											</span>
                                            ...
                                            <a href="<?php echo SERVER_ROOTPATH;?>like/detail?artist=<?php echo $artist_seo;?>&critaria=1" data-toggle="modal" data-target="#missing_popular_review_Modal2_5000" data-title="" class="link-disable" style="color:#fff;"> <?php echo $counter_main;?><?php if($counter_main<2){ echo " Like";} else {  echo " Likes"; }?></a></span>
											<span style="float:right;" class="like-group liked" id="myStyle_sub_popular_<?php echo $artist_id; ?>"></span>
											<?php
											}
											}else{
											...
											<a href="<?php echo SERVER_ROOTPATH;?>like/detail?artist=<?php echo $artist_seo;?>&critaria=1" data-toggle="modal" data-target="#missing_popular_review_Modal2_5000" data-title=""  class="like link-disable" style="margin-left:4px;color:#fff;"> <?php echo $counter_main;?><?php if($counter_main<2){ echo " Like";} else {  echo " Likes"; }?></a></span>
                                            <span style="float:right;" class="like-group liked" id="myStyle_sub_popular_<?php echo $artist_id; ?>"></span>
											<?php
											}
											?>
 								...
 								<div class="album_detail">
                                    ...
                                    <!--<cite class="lightgreen">3.0</cite>-->
                                    	<cite style="background-color:<?php echo $color_pick;?>"><?php if($review_rating==10){echo number_format($review_rating,0);}else { echo $review_rating;}?></cite>
                                    </p>
									...
									?></a>
 									...
 									<div class="review_screen_txt col-lg-4 col-md-4 col-sm-4 col-xs-4 rev_pad_left" style="text-align:center;">
 										<span class="usrdetails darkgrey_rev" style="overflow:visible !important; font-size:12px;"><!--<img src="images/icon_time.png">--><?php echo date("d M Y",$review_post_date);?></span>
 									</div>
                                    <!--Ipad-->
							...
							if($_SESSION[USER_SESSION_ARRAY]['USER_ID']!="")
							{
								...
								if($counter==0)
								{
									...
									?>
									  ...
									  <a href="process/detail_review?user=<?php echo urlencode($user_name);?>&review_id=<?php echo $db_review_id;?>&critaria=1" data-toggle="modal" data-target="#review_modal" data-title=""  class="like link-disable darkgrey_rev"> <?php if($counter_main<2){ echo " Like";} else { echo "Likes"; }?></a></span>
