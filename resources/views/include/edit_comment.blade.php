...
<div class="modal-body" style="padding:0; border:2px solid #666;">
    ...
    <img onclick="close_comment_popup();" data-dismiss="modal" src="<?php echo SERVER_ROOTPATH;?>images/crosspng.png" style="float:right; cursor:pointer; margin-top:10px; margin-right:10px;">
     ...
     <div style="margin-top:0;">
                <form name="discussion_form" id="discussion_form" method="post"  style="padding:10px; padding-top:20px;">
               ...
               <button id="button" name="submit_btn" style="margin-top:10px; display:inline; width:40%;" class="btn btn-lg btn-primary btn-block" type="submit" onClick="return discussion_validation_new()">Update</button>
                
                 <a  href="<?php echo SERVER_ROOTPATH;?>delete_comment.php?comment_id=<?php echo $comment_id;?>&num=<?php echo $num;?>&critaria=1" data-toggle="modal" data-target="#delete_comment_<?php echo $num;?>" data-title="" data-dismiss="modal" class="link-disable">
              ...
              <!--  <button id="delete_btn" name="delete_btn" style="display:inline; width:40%; float:right; margin-top:10px; background-color:#D73B3B; border-color:#D73B3B;" onClick="return discussion_delete(<?php echo $comment_id;?>);" class="btn btn-lg btn-primary btn-block" type="button">Delete</button>-->
              </form>
            </div>
	    </div>
    </div>
