							...
							<div class="album_details col-lg-9 col-md-9 col-sm-9 col-xs-9" style="padding:0;">
								<div class="row" style="margin-top:6px; margin-left:4px;">
									...
									<label class="label_class title col-lg-2 col-md-2 col-sm-2 col-xs-2">
										...
										<?php if ($mobile_view == 1) { ?>
										<label
											class="label_class likes popup_position pad_popup_left col-lg-7 col-md-7 col-sm-7 col-xs-6">
											<?php } elseif ($mobile_view == 0) { ?>
											<label
											...
											<p class="screen-pp" style="margin-top:15px;">
												<label class="label_class likes col-lg-3 col-md-3 col-sm-3 col-xs-3"
													style="margin-right:5px; margin-left:14px; padding:0;"><i
														...
														style="color:#000000;"> Likes <span
															style="color:#D73B3B;"><?php echo $count_like_review + $like_playlist_count; ?></span></a></label>
											...
											<p class="mobile-pp" style="margin-top:5px;">
												<label class="label_class col-lg-3 col-md-3 col-sm-3 col-xs-12 likes"
													style="margin-right:5px; margin-left:14px; padding:0;"><i
														class="fa fa-heart-o" style="font-size:23px;"></i><a
												...
												<label class="label_class reviews col-lg-4 col-md-4 col-sm-4 col-xs-6"
													style="padding-right:0;"> <img
														src="<?php echo SERVER_ROOTPATH; ?>images/review-book.png"
														style="margin-bottom:8px;"><a style="color:#000000;"> Reviews
												...
												<label class="label_class reviews col-lg-3 col-md-3 col-sm-3 col-xs-6">
													<img src="<?php echo SERVER_ROOTPATH; ?>images/icon_post.png"
														style="margin-bottom:7px;"><a style="color:#000000;"> Posts
