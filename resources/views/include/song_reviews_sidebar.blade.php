        ...
        <div class="review_item">
                    ...
                    <div class="row">
                        ...
                        <div class="review_screen_txt col-lg-9 col-md-8 col-sm-8 col-xs-8 pad_right">
                            <label class="mrg_btm font_wgt"><a
                                    ...
                                    style="font-size: 16px; color: #fff; font-family: 'Montserrat', sans-serif;"><?php echo substr($song_title, 0, $screen_chr);
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-4 pad_zero">
                            <span style="float:right; margin-right:8px;" class="like-group">
                                ...
                                <span
                                    id="other_dis_sub_popular_<?php echo $artist_id; ?>_<?php echo $p_fav; ?>"><a
                                        ...
                                        onClick="like_artist_recent_reviews('<?php echo $artist_id; ?>','<?php echo $p_fav; ?>','<?php echo $artist_seo; ?>')"><i
                                            class="fa fa-heart-o" style="font-size:24px; color:#c63937;"></i>
                                    ...
                                    <a href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_id; ?>&critaria=1"
                                        ...
                                        class="link-disable" style="color:#FFFFFF;"> <?php if ($counter_main < 2) {
                                                    echo "Like";
                                                } else {
                                                    echo "Likes";
                                                } ?>
                                ...
                                <span
                                    ...
                                    <a href="javascript:;"
                                        onClick="like_artist_recent_reviews('<?php echo $artist_id; ?>','<?php echo $p_fav; ?>','<?php echo $artist_seo; ?>')"
                                        style="color:red"><i class="fa fa-heart"
                                            style="font-size:24px; color:#c63937;"></i></a> <?php echo $counter_main; ?>
                                    <a href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_id; ?>&critaria=1"
                                        data-toggle="modal" data-target="#artist_modal" data-title=""
                                        class="link-disable" style="color:#FFFFFF;"> <?php if ($counter_main < 2) {
                                                    echo "Like";
                                ...
                                <span
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#signin_form"><i
                                            class="fa fa-heart-o text_grey" style="font-size:24px; color:#c63937;"></i>
                                    </a>
            ...
            <div class="album_detail">
                ...
                <p style="margin-bottom:16px;"><span style=" white-space:normal;"><a class="review_detail darkgrey_rev"
                            href="<?php echo SERVER_ROOTPATH . $song_seo . "/reviewslist/" . $artist_seo . "/" . $position_find . "#review_" . $review_id; ?>"><?php $detail_rev  = substr($review_detail, 0, 128);
                        ...
                        if ($review_user_id == $user_id) {
                            ...
                            <span class="darkgrey_rev"
                                id="other_dis_sub_<?php echo $db_review_id; ?>"><a
                                    href="javascript:;" title="your own review"><i class="fa fa-heart-o text_grey"
                                ...
                                <span class="darkgrey_rev"
                                    id="other_dis_sub_<?php echo $db_review_id; ?>"><a
                                        ...
                                        onClick="add_in_favourite_list_review_song('<?php echo $db_review_id; ?>','<?php echo $user_name; ?>','<?php echo $r_fav; ?>')"><i
                                            class="fa fa-heart-o" style="font-size:24px; color:#D73B3B;"></i>
                                    </a><?php echo $counter_main;
                        } ?>
