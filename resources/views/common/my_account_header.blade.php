...
?>
        <div class="text_12 review_ipad" style="margin-top:5px;">
            ...
            <?php if ($mobile_view == 1) { ?> &nbsp;&nbsp; | &nbsp;&nbsp; <?php } else { ?> <br> <?php } ?>
            <a href="javascript:void(0)" onclick="Delete_User('<?php echo session()->get('user_id') ?>')" style="color:#000000; float:left;"><i class="fa fa-trash-o text_red" style="margin-right:3px;"></i>&nbsp;Delete Account</a>
    ...
    ?>
        <div class="text_12" style="margin-top:5px; float:left;">
            ...
            <a href="javascript:void(0)" onclick="Delete_User('<?php echo session()->get('user_id') ?>')" style="color:#000000; margin-top:-3px;"> <i class="fa fa-trash-o text_red" style="margin-right:3px;"></i>&nbsp;Delete Account</a>
