<script type="text/javascript">
    ...
    var servername = "http://127.0.0.1:8000/",
        ...
        IMAGE_PATH = servername + "images/";

    $(function() {
        $(".mob_navigat a").on("click", function() {
            $("body").hasClass("nav-bar-open") ? ($("body").removeClass("nav-bar-open"), $(this).children("i").addClass("fa-bars"), $(this).children("i").removeClass("fa-times")) : ($("body").addClass("nav-bar-open"), $(this).children("i").removeClass("fa-bars"), $(this).children("i").addClass("fa-times"))
        }), $(window).resize(function() {
            var a = $(this).width();
            a > 1024 && ($("body").removeClass("nav-bar-open"), $(".mob_navigat i").addClass("fa-bars"), $(".mob_navigat i").removeClass("fa-times")), a > 767 && $(".head_left").removeAttr("style")
        })
    });
</script>
...
<?php } ?>
<?php if ($currentFile == 'song_detail' || $currentFile == 'song_local_detail' || $currentFile == 'edit_review') { ?>
    <script src='<?php echo COOKIE_FREE_ROOTPATH; ?>js/jquery.js' type="text/javascript"></script>
