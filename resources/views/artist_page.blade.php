            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                                        ...
                                        <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                            ...
                                            <div class="col-lg-7 col-md-7 col-sm-8 col-xs-8 pad_right">
                                                <div class="album_details" style="width:100%;">
                                                    ...
                                                    <?php } ?>
                                                    <p>
                                                        <label class="reviews"><img src="images/review-book.png"><a>Reviews <span><?php echo $review_list_arr_top['count_reviews']; ?></span></a></label>
                                                        <label class="reviews" style="margin-left:10px;"><img src="images/icon_post.png"><a>Posts <span><?php echo $comment_list_arr['count_discussion']; ?></span></a></label>
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ipad_show_div" style="padding-right:0">
                                                ...
                                                ?>
                                                    <a data-title="" data-target="#show_playlist" data-toggle="modal" href="<?php echo SERVER_ROOTPATH; ?>add-playlist?song_id=<?php echo $id; ?>&art_id=<?php echo $artist_id_db; ?>" style="padding:0; float:right; margin-right:6px;"><img src="<?php echo addtoplaylist_icon(); ?>" title="Add to Playlist" /></a>
                                                <?php
                                                }
                                                ?>
                                            ...
                                            <div class="show_default">
                                                ...
                                                ?>
                                                    <a class="playlist_icon" data-title="" data-target="#show_playlist" data-toggle="modal" href="<?php echo SERVER_ROOTPATH; ?>add-playlist?song_id=<?php echo $id; ?>&art_id=<?php echo $artist_id_db; ?>" style="margin-top:17px; float:right;"><img src="<?php echo addtoplaylist_icon(); ?>" title="Add to Playlist" /></a>
                                                <?php
                                                }
                                                ?>
                                                <div class="clear"></div>
                    ...
                    <?php
                                                            ...
                                                            if ($req_song['song_array']['image4'] != "") {
                                                            ?>
                                                                <img src="<?php echo $req_song['song_array']['image4']; ?>" border="0" width="120" style="max-width:inherit; height:80px !important;" class="3s" />
                                                                <?php
                                                            } else
													if ($album_picture != "") {
                                                                ...
                                                                ?>
                                                                <img src="<?php echo SERVER_ROOTPATH; ?>assets/images/no_image4.png" border="0" width="100" style="max-width:inherit; height:80px !important;" class="5s" />
                                                        <?php
                                                            }
                                                        }
                                                        ?>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-right:2px !important;">
                                            <div class="col-sm-5 col-xs-5">
                                                ...
                                                ?>
                                                    <a data-title="" data-target="#show_playlist" data-toggle="modal" href="<?php echo SERVER_ROOTPATH; ?>add-playlist?song_id=<?php echo $id; ?>&art_id=<?php echo $artist_id_db; ?>" style="padding:0; float:left; margin-right:6px;"><img src="<?php echo addtoplaylist_icon(); ?>" title="Add to Playlist" /></a>
                                                <?php
                                                }
                                                ?>
                                            </div>
