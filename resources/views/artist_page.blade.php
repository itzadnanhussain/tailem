...
<!-- Middle Section -->
<section class="middle_sec artistSongspic" style="top:33px; margin-bottom:-25px;">
    <div class="topsonglistsec" style="padding-top:25px !important; padding-bottom:0px !important;">
        ...
        <div class="container" style="padding:20px 0 20px 0;">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="text-align:center;"> <?php echo ads_info('Top'); ?>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-0 col-xs-0 artist_screen">&nbsp;</div>
            </div>
        </div>
        ...
        <?php
        //die();
        //echo "select l.id from tbl_likes l, tbl_artists a where l.like_type = 'artist' AND l.like_id = a.id AND a.id = $artist_id_db";
        ...
        <div class="container" style="padding:0;">
            ...
            echo '<br>';
                                        ...
                                        <small style="color:#000000; font-size:14px;">
                                            <?php if ($user_id != "") {
            /*echo "select id from tbl_likes where like_from_user_id = '".$user_id."' AND  	like_type = 'artist' AND like_id = '$artist_id_db'"; */
            ...
            if ($counter == 0) { ?>
                                            <span
                                                ...
                                                <a href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_seo; ?>&critaria=1"
                                                    ...
                                                    style="color:#444;" class="link-disable">
            ...
            ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <p style="padding:5px;"> <a class="heart_color"
                                            href="<?php echo SERVER_ROOTPATH .  Slug($artist_seo) . "/artist-songs"; ?>"
                                            aria-controls="song">Songs</a> - <a
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0 26px;">
                                    ...
                                    <div class="album_cover" style="float:left; padding: 0 5px 0 0; width:auto;">
                                        ...
                                        <cite class="score_big mt-10"
                                            style="left:3px;  background-color:<?php echo $array_score['color_pick']; ?>">
                                    ...
                                    <p
                                        ...
                                        </span> <span id="show_more_info" style="display:none;"><?php echo $artist_description; ?>
                ...
                <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12" style="max-height:200px;">
                    ...
                    <div class="review_item artist_screen"> <?php echo ads_info('right'); ?>
                    </div>
    ...
    <div class="topsonglistsec" style="padding:20px 0 0 0;">
        <div class="container" style="padding:0;">
            <div class="row">
                ...
                $artist_list = "select b.years,s.song_title,s.song_seo,b.album_title, b.album_picture, s.id,s.picture, s.song_year from tbl_artist_album b, tbl_songs_artist_album saa, tbl_songs s where s.id = saa.song_id AND saa.artist_id = $artist_id_db AND b.album_artist_id = $artist_id_db AND b.id = saa.album_id AND saa.display_status = 1 AND s.song_status = 1 group by saa.song_id order by $order_by";
                ...
                if ($sort != '') {
                    $targetpage = SERVER_ROOTPATH . Slug($artist_seo) . "/artist-songs" . $sort; //your file name  (the name of this file)
                } else {
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <label>Sort by:</label>
                                <select class="button_position select_year" id="sort"
                                    onChange="sort_area(this.value,'<?php echo $artist_seo; ?>')">
                                    <option value="year" <?php if ($sort == "year") { ?>
                                        selected<?php } ?>>Year
                                        Released</option>
                                    <option value="highest_rating" <?php if ($sort == "highest_rating") { ?>
                                        selected<?php } ?>>Highest
                                        Rating</option>
                    ...
                    <ul class="songlistings">
                        ...
                        <li>
                            ...
                            <div class="row artist_screen">
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 pad_right pad_left"> <span
                                        class="list_no">
                                        <?php if (strlen($sr_num) == 1) {
                                        echo "0";
                                    } else {
                                    }; ?><?php echo trim($sr_num); ?>
                                    </span> </div>
                                ...
                                if ($pos === true) {
                                    ...
                                    // echo "$picture!=sd2";
                                                            ...
                                                            $picture_result = substr($picture, 0, 4);
                                    if ($picture_result == 'http' || $picture_result == 'https') {
                                        $picture = str_replace("is1.mzstatic.com", "is4.mzstatic.com", $picture);
                                        $picture = str_replace("is2.mzstatic.com", "is4.mzstatic.com", $picture);
                                        $picture = str_replace("is3.mzstatic.com", "is4.mzstatic.com", $picture);
                                        $picture = str_replace("is5.mzstatic.com", "is4.mzstatic.com", $picture); ?>
                                                <img src="<?php echo $picture; ?>"
                                                    border="0" width="120" />
                                                <?php
                                    } else { ?>
                                    ...
                                    if ($req_song['song_array']['image4'] != "") {
                                        ...
                                        $result = substr($album_picture, 0, 4);
                                        if ($result == 'http' || $result == 'https') {
                                            $album_picture = str_replace("is1.mzstatic.com", "is4.mzstatic.com", $album_picture);
                                            $album_picture = str_replace("is2.mzstatic.com", "is4.mzstatic.com", $album_picture);
                                            $album_picture = str_replace("is3.mzstatic.com", "is4.mzstatic.com", $album_picture);
                                            $album_picture = str_replace("is5.mzstatic.com", "is4.mzstatic.com", $album_picture);
                                            //return $val;
                                                                    //var_dump($album_picture);?>
                                                ...
                                                <img src="<?php echo SERVER_ROOTPATH; ?>site_upload/album_images/<?php echo 'thumb_' . $album_picture; ?>"
                                                    border="0" width="100" />
                                                <?php  }
                                        //echo "$album_picture!=sd5";
                                    } else {
                                        //echo "$album_picture!=elsesssd6";?>
                                                <img src="<?php echo SERVER_ROOTPATH; ?>assets/images/no_image4.png"
                                                    border="0" width="100" />
                                                <?php
                                    }
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-8 col-xs-8 pad_right">
                                        <div class="album_details" style="width:100%;">
                                            <label class="title"><a
                                                    href="<?php echo SERVER_ROOTPATH .  Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"><?php echo $song_title; ?></a></label>
                                            <label class="author"><a
                                                    href="<?php echo SERVER_ROOTPATH .  Slug($artist_seo) . "/artist-songs"; ?>"><?php echo $db_artist_name; ?></a></label>
                                            ...
                                            <p>
                                                ...
                                                <label class="reviews" style="margin-left:10px;"><img
                                                        src="<?php echo SERVER_ROOTPATH ?>images/icon_post.png"><a>Posts
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ipad_show_div"
                                        ...
                                        <a data-title="" data-target="#show_playlist" data-toggle="modal"
                                            href="<?php echo SERVER_ROOTPATH; ?>add-playlist?song_id=<?php echo $id; ?>&art_id=<?php echo $artist_id_db; ?>"
                                            style="padding:0; float:right; margin-right:6px;"><img
                                                src="<?php echo addtoplaylist_icon(); ?>"
                                                title="Add to Playlist" /></a>
                                        <?php
                                        ...
                                        <a href="<?php echo SERVER_ROOTPATH   .Slug($song_seo) . "/write-a-review/" . Slug($artist_seo); ?>"
                                            style="float:right; margin-right:26px;"><button style="margin-left:0">Write
                                                a Review</button></a>
                                    ...
                                    <div class="show_default">
                                        ...
                                        <a class="playlist_icon" data-title="" data-target="#show_playlist"
                                            data-toggle="modal"
                                            href="<?php echo SERVER_ROOTPATH; ?>add-playlist?song_id=<?php echo $id; ?>&art_id=<?php echo $artist_id_db; ?>"
                                            style="margin-top:17px; float:right;"><img
                                                src="<?php echo addtoplaylist_icon(); ?>"
                                                title="Add to Playlist" /></a>
                                        <?php
                                                } ?>
                                        <div class="clear"></div>
                                        <a href="<?php echo SERVER_ROOTPATH   .Slug($song_seo) . "/write-a-review/" . Slug($artist_seo); ?>"
                                            style="margin-top:17px; float:right;">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding:0px !important;">
                                    <div class="album_cover"> <a
                                            ...
                                            <?php
                                                            ...
                                                            /*if($img_api_link !=''){
                                                    ?>
                    <img src="<?php echo $img_api_link;?>"  border="0"     width="120" style="max-width:inherit; height:80px !important;" class="1s"/>
                    <?php }else{ ?>
                    <img src="<?php echo SERVER_ROOTPATH;?>site_upload/song_images/<?php echo 'thumb_'.$picture;?>"  border="0"  width="120"  style="max-width:inherit; height:80px !important;" class="2s"/>
                    <?php
                                                }*/
                                                        } else {
                                                            //$req_song  =  artist_album_song_func($db_artist_name,stripslashes(html_entity_decode($val['song_title'])));
                                            ...
                                            <img src="<?php echo $req_song['song_array']['image4']; ?>"
                                                border="0" width="120"
                                                style="max-width:inherit; height:80px !important;" class="3s" />
                                            <?php
                                                            } elseif ($album_picture != "") {
                                                                $result = substr($album_picture, 0, 4);
                                                                if ($result == 'http' || $result == 'https') {
                                            ...
                                            <img src="<?php echo SERVER_ROOTPATH; ?>assets/images/no_image4.png"
                                                border="0" width="100"
                                                style="max-width:inherit; height:80px !important;" class="5s" />
                                            <?php
                                                            }
                                                        } ?>
                                        </a>
                                        ...
                                        <div style="position:absolute; z-index:10; margin-left:84%; color:#FFFFFF; margin-top:-20px;"
                                            class="review_screen_txt"><?php echo $sr_num; ?>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-right:2px !important;">
                                ...
                                <div class="col-sm-7 col-xs-7" style="padding-right:20px; float:right;"> <a
            ...
            <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
                <div class="row">
                    <div class="review_item artist_mobile" style="margin-top:5px;"> <?php echo ads_info('right'); ?>
                    </div>
                </div>
            ...
            <div class="container" style="padding:20px 0 20px 0;">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-0 col-xs-0 artist_screen">&nbsp;</div>
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="text-align:center;"> <?php echo ads_info('Bottom'); ?>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-0 col-xs-0 artist_screen">&nbsp;</div>
                </div>
            </div>
...
<script type="text/javascript">
    function sort_area(val, artist_seo) {
        window.location.href = "<?php echo SERVER_ROOTPATH; ?>" + artist_seo +
            "/artist-songs/" + val;
    }
</script>