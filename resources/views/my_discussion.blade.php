                            ...
                            if (strlen($song_title) > 19) {
                                echo "..";
                                        ...
                                        <label class="author pad_left"><a
                                                href="<?php echo SERVER_ROOTPATH . Slug($artist_seo) . "/artist-songs"; ?>"><?php echo substr($artist_name, 0, 19);
                                        ...
                                        <label class="likes">
                                            ...
                                            <span style="overflow:visible;"
                                                id="other_dis_sub_<?php echo $sr_no; ?>_<?php echo $artist_id; ?>"><a
                                                    href="javascript:;"
                                                    onClick="add_in_favourite_list_sub_artist_new('<?php echo $artist_id; ?>','<?php echo $sr_no; ?>','<?php echo $artist_seo; ?>','<?php echo $sr_no; ?>')"><i
                        ...
                        <div class="col-lg-5 col-md-4 col-sm-4 col-xs-5 pad_zero">
                            ...
                            if (strlen($artist_name) > 10) {
                                ...
                                <label class="author pad_left"><strong class="heart_color"
                                        style="font-size:16px; font-weight:500; ">ft.</strong> <?php echo $feature_artists; ?></label><br>
                                <?php } ?>
                                <label class="likes mrg_btm" style="min-height:50px !important;">
                                    ...
                                    <span style="overflow:visible;"
                                        id="other_dis_sub_<?php echo $srr_no; ?>_<?php echo $artist_id; ?>"><a
                                            href="javascript:;"
                                            onClick="add_in_favourite_list_sub_artist_new('<?php echo $artist_id; ?>','<?php echo $srr_no; ?>','<?php echo $artist_seo; ?>','<?php echo $sr_no; ?>')"><i
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 pad_zero rew_item">
                                ...
                                if ($counter == 0) { ?>
                                                    ...
                                                    <span class="like-group"
                                                        ...
                                                        id="other_dis_sub_profile_<?php echo $sr_no; ?>"><a
                                                            href="javascript:;"
                                                            onClick="add_in_favourite_user_profile_mainlist_new('<?php echo $comment_user_id; ?>','<?php echo $sr_no; ?>','<?php echo $user_name; ?>')"><i
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8 desc_pan pad_zero">
                                ...
                                <div class="list-inline col-lg-12 col-md-12 col-sm-12 col-xs-12 pad_zero">
                                    <p class="dateVale col-lg-8 col-md-8 col-sm-8 col-xs-8 pad_left"
                                        style="font-size:12px;"><?php echo $db_comment_post_date; ?>
                                    </p>
                                    <p class="col-lg-4 col-md-4 col-sm-4 col-xs-4 ">
                                        ...
                                        <a class="linktag_new under_line"
                                            href="<?php echo SERVER_ROOTPATH; ?>report_discussion_new.php?rev_id=<?php echo $comment_id; ?>&num=<?php echo $sr_no; ?>"
                                            data-toggle="modal"
                                            data-target="#report_Modal4_<?php echo $sr_no; ?>"
                                            data-title="">Report</a>
                                        <?php
                                                            }
                                                        }
                            ...
                            if ($user_profile == $user_id) {
                                ?>
                                        <a class="linkTag under_line" data-title=""
                                            ...
                                            data-toggle="modal"
                                            href="<?php echo SERVER_ROOTPATH; ?>edit_comment?comment_id=<?php echo $comment_id; ?>&num=<?php echo $sr_no; ?>">Edit</a>
                                        <?php
                            } ?>
                                        <span
                        ...
                        <div class="latestsongssec">
                            <div class="list_item">
                                ...
                                <div class="list_bottom" style="padding:2px; width:100px;">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"
                                            style="padding-left:2px; padding-right:16px; margin-top:5px;">
                                            <?php
                                                                $qry = "select id from tbl_likes where like_type = 'profile' AND like_id = '$comment_user_id'";
                            $counter_main = array();
                            $counter_main = \App\Models\Songs::GetRawData($qry);
                            ...
                            if ($user_id != "") {
                                ...
                                if ($counter == 0) { ?>
                                            ...
                                            <span class="like-group" style="float:right; line-height:20px !important;"
                                                id="other_dis_sub_profile_sc_<?php echo $sr_no; ?>"><a
                                                    href="javascript:;"
                                                    onClick="add_in_favourite_user_profile_screen_new('<?php echo $comment_user_id; ?>','<?php echo $sr_no; ?>','<?php echo $user_name; ?>')"><i
                                                        class="fa fa-heart-o heart_color" style="font-size:20px;"></i>
                                                </a><a
                                                    href="<?php echo SERVER_ROOTPATH; ?>process/detail_profile?user=<?php echo urlencode($user_name); ?>&critaria=1"
                                                    data-toggle="modal" data-target="#profile_modal" data-title=""
                                                    class="like link-disable" style="color:#FFFFFF;"> <?php echo $counter_main; ?></a></span>
                                            ...
                                            <span class="like-group" style="float:right; line-height:20px !important;"
                                                id="other_dis_sub_profile_sc_<?php echo $sr_no; ?>"><a
                                                    ...
                                                    onClick="add_in_favourite_user_profile_screen_new('<?php echo $comment_user_id; ?>','<?php echo $sr_no; ?>','<?php echo $user_name; ?>')"><i
                                                        class="fa fa-heart"
                                                        style="color:#d73b3b !important; font-size:20px;"></i> </a><a
                                                    href="<?php echo SERVER_ROOTPATH; ?>process/detail_profile?user=<?php echo urlencode($user_name); ?>&critaria=1"
                                                    data-toggle="modal" data-target="#profile_modal" data-title=""
                                                    class="like link-disable" style="color:#FFFFFF;"> <?php echo $counter_main; ?></a></span>
                                            <span class="like-group" style="float:right; line-height:20px !important;"
                                ...
                                ?>
                                            ...
                                            <span class="like-group" style="float:right; line-height:20px !important;"
                                                ...
                                                <a href="<?php echo SERVER_ROOTPATH; ?>process/detail_profile?user=<?php echo urlencode($user_name); ?>&critaria=1"
                                                    data-toggle="modal" data-target="#profile_modal" data-title=""
                                                    class="like link-disable" style="color:#FFFFFF;"> <?php echo $counter_main; ?></a>
                                            </span>
                                            <span class="like-group" style="float:right; line-height:20px !important;"
                                                id="myStyle_sub_profile_sc_<?php echo $sr_no; ?>"></span>
                                ...
                                <p><label class="likes"
                                        ...
                                        <span style="overflow:visible;"
                                            id="other_dis_sub_mob_<?php echo $sr_no; ?>_<?php echo $artist_id; ?>"><a
                                                href="javascript:;"
                                                onClick="add_in_favourite_list_sub_artist_mob_new('<?php echo $artist_id; ?>','<?php echo $sr_no; ?>','<?php echo $artist_seo; ?>','<?php echo $sr_no; ?>')"><i
                                                    class="fa fa-heart-o heart_color heart_size"></i> </a><span><?php echo $counter_main2; ?></span><a
                                                href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_seo; ?>&critaria=1"
                                                data-toggle="modal" data-target="#artist_modal" data-title=""
                                                class="like link-disable" style="color:#444;"><?php if ($counter_main2 < 2) {
                                                                        echo " Like";
                                                                    } else {
                                                                        echo " Likes";
                                                                    } ?>
                                        ...
                                        <span style="overflow:visible;"
                                            id="other_dis_sub_mob_<?php echo $sr_no; ?>_<?php echo $artist_id; ?>"><a
                                                href="javascript:;"
                                                onClick="add_in_favourite_list_sub_artist_mob_new('<?php echo $artist_id; ?>','<?php echo $sr_no; ?>','<?php echo $artist_seo; ?>','<?php echo $sr_no; ?>')"><i
                                                    class="fa fa-heart heart_color heart_size"></i> </a><span><?php echo $counter_main2; ?></span><a
                                                href="<?php echo SERVER_ROOTPATH; ?>like/detail?artist=<?php echo $artist_seo; ?>&critaria=1"
                                                data-toggle="modal" data-target="#artist_modal" data-title=""
                                                class="like link-disable" style="color:#444;"><?php if ($counter_main2 < 2) {
                                                                        echo " Like";
                    ...
                    <div class="rew_item" style="border:none; ">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pad_zero darkgrey_rev">
                            ...
                            <p class="like_right" style="margin-top:12px;"> <?php
                                ...
                                <a class="linktag_new under_line" data-title=""
                                    data-target="#report_Modal4_<?php echo $sr_no; ?>"
                                    data-toggle="modal"
                                    href="<?php echo SERVER_ROOTPATH; ?>report_discussion_new.php?rev_id=<?php echo $comment_id; ?>&num=<?php echo $sr_no; ?>">Report</a>
                                <?php
                                                                                                        }
                                                                                                    }
                                                                                                } ?>
