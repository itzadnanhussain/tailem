                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-11 pad_zero">
                                            ...
                                            <div class="album_details" style="margin-top:-3px;">
                                                ...
                                                <label class="author pad_left"><a href="<?php echo SERVER_ROOTPATH . $artist_seo . "-artist-songs"; ?>"><?php echo substr($artist_name, 0, 19);
                                ...
                                <div class="review_sng_mrg review_ipad_txt">
                                        ...
                                        <div class="album_details mrg_top">
                                            ...
                                            <label class="likes mrg_btm" style="min-height:50px !important;">
                                                ...
                                                ?>
                                                    ...
                                                    $srr_no = $sr_no + time();
                                                    ?>
                                                    <span style="overflow:visible;" id="other_dis_sub_<?php echo $srr_no; ?>_<?php echo $artist_id; ?>"> <?php
                                                                                                                                                            if ($user_id == "") {
                                                                                                                                                            ?>
                                                            <a href="#" data-toggle="modal" data-target="#signin_form"><i class="fa fa-heart-o heart_color heart_size"></i></a>
                                                        <?php
                                            ...
                                            <!--<p style="margin-top:-22px;"><?php echo $years; ?></p>-->
                                        </div>
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 pad_zero rew_item">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8 desc_pan pad_zero">
                                            <p style="min-height:70px;"><?php echo $comment_details; ?></p>

                                            <div class="list-inline col-lg-12 col-md-12 col-sm-12 col-xs-12 pad_zero">
                                                <p class="dateVale col-lg-8 col-md-8 col-sm-8 col-xs-8 pad_left" style="font-size:12px;"><?php echo $db_comment_post_date; ?></p>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 pad_zero mobile-responsive">
                                                <div class="album_details" style="display:block; margin-top:-3px;">
                                                    ...
                                                    <label class="author mrg_btm"><a href="<?php echo SERVER_ROOTPATH . $artist_seo . "-artist-songs"; ?>"><?php echo $artist_name; ?></a>
                                                    ...
                                                    <p><label class="likes" style="float:left; height:26px; margin-left:0px; padding-left:0px;">
                                                            ...
                                                            ?>
                                                                ...
                                                                <span style="overflow:visible;" id="other_dis_sub_mob_<?php echo $sr_no; ?>_<?php echo $artist_id; ?>">
                                                                    ...
                                                                    ?>
                                                                    <span><?php echo $counter_main2; ?></span><a href="<?php echo SERVER_ROOTPATH; ?>detail.php?artist=<?php echo $artist_seo; ?>&critaria=1" data-toggle="modal" data-target="#artist_modal" data-title="" class="like link-disable" style="color:#444;"><?php if ($counter_main2 < 2) {
                                                                                                                                                                                                                                                                                                                                echo " Like";
                                                                                                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                                                                                                echo " Likes";
                                                                                                                                                                                                                                                                                                                            } ?></a></span>
                                    ...
                                    <div class="rew_list-panel pad_zero mrg_top">
                                        <div class="rew_item" style="border:none; ">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pad_zero darkgrey_rev">
                                                <p style="min-height:40px;" class="review_detail"><?php echo $comment_details; ?></p>


                                                <p class="dateVale" style="margin-top:12px; font-size:12px; float:left;"><?php echo $db_comment_post_date; ?></p>
