    ...
    <div class="banner">
        <div class="banner_body">
            ...
            <div class="banner-search">
                <form
                    action="<?php echo SERVER_ROOTPATH; ?>searcher-results-album"
                    method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            ...
                            placeholder="Search for a Album" id="search" name="search" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                    ...
                                    <div class="album_details" style="margin-top:0; padding: 2% 0 0 4%;">
                                        <label class="title review_screen_txt " style="margin-bottom:5px;"><a
                                        ...
                                        <label class="review_ipad_txt title" style="margin-bottom:5px;"><a
                                                href="<?php echo SERVER_ROOTPATH . $artist_seo . "/album/" . $album_seo; ?>"><?php echo substr($album_title, 0, 20);
                                        ...
                                        <div>
                                            <label class="author" style="width:400px; float:left;">
                                                <?php
                                                            ...
                                                            if ($various) {
                                                                ?>
                                                <a
                                                    href="<?php echo SERVER_ROOTPATH . Slug($various['artist_seo']) . "/artist-songs"; ?>"><?php echo substr($various['artist_name'], 0, 25);
                                            ...
                                            <label class="likes">
                                                ...
                                                <span style="overflow:visible;"
                                                    id="other_dis_sub_<?php echo $album_artist_id; ?>"><a
                                                        href="javascript:;"
                                                        onClick="add_in_favourite_list_sub('<?php echo $album_artist_id; ?>','<?php echo $artist_seo; ?>','<?php echo $k_album; ?>')"
                                                        class="text_grey"><i
                                                            class="fa fa-heart-o heart_size heart_color"></i> </a><span
                                                ...
                                                <span style="overflow:visible;"
                                                    id="myStyle_sub_<?php echo $album_artist_id; ?>"></span>
                                                ...
                                                <span style="overflow:visible;"
                                                    id="other_dis_sub_<?php echo $album_artist_id; ?>">
                                                    <?php
                                                                    if ($user_id == "") {
                                                                        ?>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding:0px !important;">
                                    <div class="album_cover">
                                        ...
                                        <?php } ?>
                                        <div
                                            style="position:inherit; z-index:10; float:right; color:#FFFFFF; margin-top:-22px; margin-right:6px;">
                                            <?php echo $sr_no; ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" style="padding:0px !important;">
                                    <div class="album_details" style="margin-top:0;">
                                        <label class="title"><a
                                                href="<?php echo SERVER_ROOTPATH . $artist_seo . "/album/" . $album_seo; ?>"><?php echo substr($album_title, 0, 25);
                                        ...
                                        <label class="author">
                                            <?php
                                                            if ($various) {
                                                                ?>
                                            <a
                                                href="<?php echo SERVER_ROOTPATH . Slug($various['artist_seo']) . "/artist-songs"; ?>"><?php echo substr($various['artist_name'], 0, 20);
