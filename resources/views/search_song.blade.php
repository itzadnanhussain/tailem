    ...
    <div class="banner">
        <div class="banner_body">
            ...
            <div class="banner-search">
                <form
                    action="<?php echo SERVER_ROOTPATH; ?>searcher-results-song"
                    method="post">
                    <div class="form-group">
                        @csrf
                        <label for="search" onClick="unset_all()" style="cursor:pointer;">All</label>
                        <input type="text" class="form-control"
                            value="<?php echo session()->get('main_search'); ?>"
                            placeholder="Search for a Song" id="search" name="search" required>
                                ...
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
                                    ...
                                    <div class="album_details" style="margin-top:0; padding: 2% 0 0 4%;">
                                        ...
                                        <label class="review_ipad_txt title" style="margin-bottom:5px;"><a
                                                href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"><?php echo substr($song_title, 0, 16);
                                        ...
                                        <label class="likes" style="float:right; height:26px; margin-top:-9px;">
                                            ...
                                            <span style="overflow:visible;"
                                                id="other_dis_sub_<?php echo $sr_no; ?>_<?php echo $db_art_id; ?>"><a
                                                    href="javascript:;"
                                                    onClick="add_in_favourite_list_sub_artist_new('<?php echo $db_art_id; ?>','<?php echo $sr_no; ?>','<?php echo $artist_seo; ?>','<?php echo $k_song; ?>')"><i
                                                        class="fa fa-heart-o"
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-right:2px !important;">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9" style="padding:0px !important;">
                                    <div class="album_details" style="margin-top:0;">
                                        <label class="title"><a
                                                href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/reviews/" . Slug($artist_seo); ?>"><?php echo substr($song_title, 0, 25);
...
<div class="modal fade"
    id="missing_store_detail_Modal2_<?php echo $u; ?>" tabindex="-1"
    role="dialog" aria-labelledby="basicModal" aria-hidden="true"></div>
<div class="modal fade"
    id="missing_store_detail_Modal22_<?php echo $u; ?>" tabindex="-1"
    role="dialog" aria-labelledby="basicModal" aria-hidden="true"></div>
<?php
}
...
for ($u = 1; $u <= $k_album; $u++) {
    ?>
<div class="modal fade" id="missing_album<?php echo $u; ?>"
