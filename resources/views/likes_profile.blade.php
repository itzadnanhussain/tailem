                                                    ...
                                                    <label class="likes pad_zero">
                                                        ...
                                                        ?>
                                                            ...
                                                            <span style="overflow:visible;" id="other_dis_sub_profile_main_<?php echo $p_fav; ?>">
                                                                ...
                                                                ?>
                                                                <span><?php echo $counter_main; ?></span><a href="<?php echo SERVER_ROOTPATH; ?>detail_profile.php?user=<?php echo urlencode($db_user_name); ?>&critaria=1" data-toggle="modal" data-target="#profile_modal" data-title="" class="darkgrey_rev link-disable" style="color:#444;"><?php if ($counter_main < 2) {
                                                                                                                                                                                                                                                                                                                                                        echo " Like";
                                                                                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                                                                                        echo " Likes";
                                                                                                                                                                                                                                                                                                                                                    } ?></a></span>
                                                        ...
                                                        <label class="likes" style="margin-left:5px; float:right;">
                                                            ...
                                                            if ($user_id != "") {
                                                                ...
                                                                <span style="overflow:visible; margin-top:-5px;" id="other_dis_sub_profile_main_<?php echo $p_fav; ?>">
                                                                    ...
                                                                    ?>
                                                                    <span><?php echo $counter_main; ?></span><a href="<?php echo SERVER_ROOTPATH; ?>detail_profile.php?user=<?php echo urlencode($db_user_name); ?>&critaria=1" data-toggle="modal" data-target="#profile_modal" data-title="" class="darkgrey_rev link-disable"><?php if ($counter_main < 2) {
                                                                                                                                                                                                                                                                                                                                        echo " Like";
                                                                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                                                                        echo " Likes";
                                                                                                                                                                                                                                                                                                                                    } ?></a></span>
