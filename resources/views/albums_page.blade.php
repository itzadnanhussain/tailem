                                        ...
                                        <small style="color:#000000; font-size:14px;">
                                            <?php if ($user_id != "") {
                                                ...
                                                <span id="other_dis_sub_<?php echo $artist_id_db; ?>">
                                                    ...
                                                    <span class="text_red"><?php echo $counter_main; ?></span> <a href="<?php echo SERVER_ROOTPATH; ?>detail.php?artist=<?php echo $artist_seo; ?>&critaria=1" data-toggle="modal" data-target="#artist_modal" data-title="" style="color:#444;" class="link-disable"><?php if ($counter_main < 2) {
                                                                                                                                                                                                                                                                                                                            echo " Like";
                                                                                                                                                                                                                                                                                                                        } else {
                                                                                                                                                                                                                                                                                                                            echo " Likes";
                                                                                                                                                                                                                                                                                                                        } ?></a></span>
                                            ...
                                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12" style="margin-top:10px; margin-bottom:10px; background-color:#F8F8F8;">
                                                ...
                                                <div class="col-lg-7 col-md-7 col-sm-8 col-xs-8 pad_right">
                                                    <div class="album_details" style="width:100%;">
                                                        ...
                                                        <p><label class="reviews"><img src="<?php echo SERVER_ROOTPATH; ?>static/images/review-book.png"><a>Reviews <span><?php echo $arr_count_reviews[$s]; ?></span></a></label><label class="reviews" style="margin-left:10px;"><img src="static/images/icon_post.png"><a>Posts <span><?php echo $arr_count_discussion[$s]; ?></span></a></label></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-3">
                                                    ...
                                                    ?>
                                                        <a data-title="" data-target="#show_playlist" data-toggle="modal" href="<?php echo SERVER_ROOTPATH; ?>add_playlist.php?song_id=<?php echo $arr_db_song_id[$s]; ?>&art_id=<?php echo $album_artist_id; ?>" style="padding:0; float:right; margin-right:6px;"><img src="<?php echo addtoplaylist_icon(); ?>" title="Add to Playlist" /></a>
                                                    <?php
                                                    }
                                                    ?>
                                                    <br />
                                            ...
                                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11" style="margin-top:10px; margin-bottom:10px; background-color:#F8F8F8; padding-right:0;">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9" style="padding:0px !important;  padding-right:0;">
                                                    <div class="album_details">
                                                        ...
                                                        <?php if ($arr_feature_artists[$s] != "") { ?>
                                                            <label class="author"><strong>ft. </strong><?php echo $arr_feature_artists[$s]; ?></label><?php } ?>
                                                        <p><label class="reviews"><img src="static/images/review-book.png"><a>Reviews <span><?php echo $arr_count_reviews[$s]; ?></span></a></label><label class="reviews"><img src="static/images/icon_post.png"><a>Posts <span><?php echo $arr_count_discussion[$s]; ?></span></a></label></p>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-right:2px !important;">
                                                    <div class="col-sm-5 col-xs-5">
                                                        ...
                                                        ?>
                                                            <a data-title="" data-target="#show_playlist" data-toggle="modal" href="<?php echo SERVER_ROOTPATH; ?>add_playlist.php?song_id=<?php echo $arr_db_song_id[$s]; ?>&art_id=<?php echo $album_artist_id; ?>" style="padding:0; float:left; margin-right:6px;"><img src="<?php echo addtoplaylist_icon(); ?>" title="Add to Playlist" /></a>
                                                        <?php
                                                        }
                                                        ?>
                                                    </div>
