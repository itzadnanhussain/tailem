                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8 desc_pan pad_zero">
                                                    ...
                                                    <div class="list-inline col-lg-12 col-md-12 col-sm-12 col-xs-12 pad_zero">
                                                        ...
                                                        <p class="col-lg-4 col-md-3 col-sm-3 col-xs-2 pad_zero">
                                                            ...
                                                            if ($db_user_id == $user_id) {
                                                            ?>
                                                                <a class="linkTag under_line" data-title="" data-target="#edit_Modal4_<?php echo $k; ?>" data-toggle="modal" href="<?php echo SERVER_ROOTPATH; ?>edit_review.php?rev_id=<?php echo $review_id; ?>">Edit</a>
                                                            <?php
                                                            }
                                                            ?>
                                                ...
                                                <div class="album_details" style="display:block; margin-top:-3px;">
                                                    ...
                                                    <p><label class="likes" style="float:left; height:26px; margin-left:0px; padding-left:0px;">
                                                            ...
                                                            if ($user_id != "") {
                                                                ...
                                                                if ($counter == 0) {
                                                            ?>
                                                                    <span style="overflow:visible;" id="other_dis_sub_mob_<?php echo $sr_no; ?>_<?php echo $artist_id; ?>"><a href="javascript:;" onClick="add_in_favourite_list_sub_artist_mob_new('<?php echo $artist_id; ?>','<?php echo $sr_no; ?>','<?php echo $artist_seo; ?>','<?php echo $k; ?>')"><i class="fa fa-heart-o heart_color heart_size"></i> </a><span><?php echo $counter_main2; ?></span><a href="<?php echo SERVER_ROOTPATH; ?>detail.php?artist=<?php echo $artist_seo; ?>&critaria=1" data-toggle="modal" data-target="#artist_modal" data-title="" class="like link-disable" style="color:#444;"><?php if ($counter_main2 < 2) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                echo " Like";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                echo " Likes";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            } ?></a></span>
                                                                ...
                                                                ?>
                                                                    <span style="overflow:visible;" id="other_dis_sub_mob_<?php echo $sr_no; ?>_<?php echo $artist_id; ?>"><a href="javascript:;" onClick="add_in_favourite_list_sub_artist_mob_new('<?php echo $artist_id; ?>','<?php echo $sr_no; ?>','<?php echo $artist_seo; ?>','<?php echo $k; ?>')"><i class="fa fa-heart heart_color heart_size"></i> </a><span><?php echo $counter_main2; ?></span><a href="<?php echo SERVER_ROOTPATH; ?>detail.php?artist=<?php echo $artist_seo; ?>&critaria=1" data-toggle="modal" data-target="#artist_modal" data-title="" class="like link-disable" style="color:#444;"><?php if ($counter_main2 < 2) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo " Like";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        } else {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo " Likes";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        } ?></a></span>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="like_right" style="padding-right:18px;">
                                                                    ...
                                                                    if ($user_id != "") {
                                                                        ...
                                                                        if ($counter == 0) { ?>
                                                                            <span lass="like-group" style="line-height:0px !important; float:right;" id="other_dis_sub_profile_mb_<?php echo $sr_no; ?>"><a href="javascript:;" onClick="add_in_favourite_user_profile_mob('<?php echo $db_user_id; ?>','<?php echo $sr_no; ?>','<?php echo $user_name; ?>')"><i class="fa fa-heart-o heart_color" style="font-size:14px; margin-top:3px; "></i> </a><a href="<?php echo SERVER_ROOTPATH; ?>detail_profile.php?user=<?php echo urlencode($user_name); ?>&critaria=1" data-toggle="modal" data-target="#profile_modal" data-title="" class="like link-disable" style="color:#fff; font-size:12px;"> <?php echo $counter_main; ?></a></span>
