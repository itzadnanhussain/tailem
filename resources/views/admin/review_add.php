...
<link href="css/style.css?id=<?php echo rand(9999,999999);?>" rel="stylesheet" type="text/css">
            ...
            <input type="hidden" name="album_id" value="<?php echo $album_id;?>">
              ...
              <table class="Panel">
                ...
                <tbody>
				 ...
				 <div id="holder"> 
		 <input type="text" id="keyword" name="review_user_id" tabindex="0" class="fields"><img src="images/load.gif" id="loading">
		 </div>
		 <div id="ajax_response"></div>
                  ...
                  <tr>
                    ...
                    <td>
                        	...
                        	<input name="edit_review" id="edit_review" value="Save" class="FormButton" type="submit" onClick="validate_add_review();"/>
