	...
	<div class="topRwHead-bodyPan">
		...
		<?php }?>
			...
			<div class="topRwContent-panel pad_zero" style="margin-bottom:15px;">
           		<div class="topsonglistsec col-lg-12 col-md-12 pad_zero ipad_top" style="background:none; border-top:none;">
				...
				<?php
						  $request_url  =  str_replace("/tailem/","",$_SERVER["REQUEST_URI"]);
						   ...
						   if($page!="")
						   {
							...
							{
								$go_topage	=	SERVER_ROOTPATH.$_REQUEST['user_seo']."-profile-like-review";
							}
							else
							{
							 ...
							 foreach($review_list_arr as $review_like_info)
							 {
							  ...
							  $title_db = urlencode("$song_title");
								...
								if($db_profile_image!="")
									...
									{
										$prof_image = SERVER_ROOTPATH."assets/images/no_image.png";
				        ...
				        <li class="review_rev_sng" style="float:left;">
                            <!--Desktop-->
								...
								?></a>
                                  ...
                                  <div class="album_details" style="margin-top:-5px;"> 
                                    ...
                                    <label class="author pad_left"><a href="<?php echo SERVER_ROOTPATH.get_user_detail($USER_NAME)."-profile-".$artist_seo."-review-albums";?>"><?php echo substr($artist_name,0,19);if(strlen($artist_name)>19)
									{
										echo "...";
									}?></a></label>
                             	...
                             	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 pad_zero">
                                   ...
                                   <a href="<?php echo SERVER_ROOTPATH.$song_seo."-reviews-".$artist_seo;?>"> <?php
                                                ...
                                                <?php } else{ ?>
													...
													{
														?>
														 <img src="<?php echo SERVER_ROOTPATH;?>assets/images/no_image.png"  border="0"  width="100" style="padding:0 8px;"/>
														<?php
													}
													?></a>
                               <?php
							...
							if($review_rating >=8)
								...
								?>
                                    ...
                                    <label class="title"><a href="<?php echo SERVER_ROOTPATH.$song_seo."-reviews-".$artist_seo;?>">
                                    <?php echo substr($song_title,0,9);if(strlen($song_title)>9)
									{
										echo "..";
									}?></a></label>
                                    <label class="author mrg_btm"><a href="<?php echo SERVER_ROOTPATH.get_user_detail($USER_NAME)."-profile-".$artist_seo."-review-albums";?>"><?php echo substr($artist_name,0,10);if(strlen($artist_name)>10)
									{
										echo "..";
									}?></a></label><br>
							...
							?>
							 ...
							 <?php											
							$counter_main = mysqli_num_rows(mysqli_query($db->dbh, "select id from tbl_likes where like_type = 'profile' AND like_id = '$db_user_id'"));
							
							if($_SESSION[USER_SESSION_ARRAY]['USER_ID']!="")
							{
								$counter =  mysqli_num_rows(mysqli_query($db->dbh, "select id from tbl_likes where like_from_user_id = '".$_SESSION[USER_SESSION_ARRAY]['USER_ID']."' AND  	like_type = 'profile' AND like_id = '$db_user_id'"));

								if($counter==0)
								{?>
										 <span class="like-group" style="float:right; line-height:20px !important;" id="other_dis_sub_profile_<?php echo $sr_no;?>"><a href="javascript:;" onClick="add_in_favourite_user_profile_mainlist_new('<?php echo $db_user_id;?>','<?php echo $sr_no;?>','<?php echo $user_name;?>')"><i class="fa fa-heart-o heart_color" style="font-size:20px;"></i> </a><a href="<?php echo SERVER_ROOTPATH;?>detail_profile.php?user=<?php echo urlencode($user_name);?>&critaria=1" data-toggle="modal" data-target="#missing_popular_review_Modal2_<?php echo $sr_no;?>" data-title="" class="like link-disable" style="color:#FFFFFF;"> <?php echo $counter_main;?></a></span>
							...
							else
							{
								...
								<span class="like-group" style="float:right; line-height:20px !important;" id="other_dis_sub_profile_<?php echo $sr_no;?>">
                                 <?php
									  ...
									  {
										?>
									 <a href="javascript:;" onClick="add_in_favourite_user_profile_mainlist_new('<?php echo $db_user_id;?>','<?php echo $sr_no;?>','<?php echo $user_name;?>')"><i class="fa fa-heart-o heart_color" style="font-size:20px;"></i></a>
										<?php
									  }
									  ?> 
							...
							<div class="col-lg-10 col-md-10 col-sm-8 col-xs-8 desc_pan pad_zero">
								<p class="title" style="margin-bottom:5px;"><span style="background-color:<?php echo $color_pick;?>; border-radius:5px;"><?php if($review_rating==10){echo number_format($review_rating,0);}else { echo $review_rating;}?></span> <a style="color:#000000" href="<?php echo SERVER_ROOTPATH.$song_seo."-reviews-".$artist_seo."#review_".$review_id;?>"><?php 
                                 ...
                                 <?php
									   if($_SESSION[USER_SESSION_ARRAY]['USER_ID']!="")
										...
										<?php }
                                                     ...
                                                     <span id="other_dis_sub_<?php echo $review_id;?>"><a href="javascript:;" onClick="add_in_favourite_list_review_song('<?php echo $review_id;?>','<?php echo $user_name;?>','<?php echo $k;?>')" class="text_grey"> <i class="fa fa-heart-o heart_color" style="font-size:20px;"></i> </a><span class="text_red"><?php echo $counter_main_rev;?></span><a href="<?php echo SERVER_ROOTPATH;?>detail_review.php?user=<?php echo urlencode($user_name);?>&review_id=<?php echo $review_id;?>&critaria=1" data-toggle="modal" data-target="#model_review_likes_<?php echo $k;?>" data-title=""  class="like link-disable" style="color:#444;"><?php if($counter_main_rev<2){ echo " Like";} else {  echo " Likes"; }?></a></span>
                                                 <span  id="myStyle_sub_<?php echo $review_id;?>"></span>
                                          <?php } ?>
                                    </p>
									<p class="col-lg-4 col-md-3 col-sm-3 col-xs-2 pad_zero">
									<?php
												if($db_user_id != $_SESSION[USER_SESSION_ARRAY]['USER_ID'])
												{
													  if($_SESSION[USER_SESSION_ARRAY]['USER_ID']=="")
													  {
														?>
														<a href="#" class="linkTag under_line" data-toggle="modal" data-target="#signin_form" style="font-size:11px; margin-top:-3px; float:right;">Report</a>
														<?php
													  }
													  else
													  {
															...
															{
																	?>
																	<a class="linkTag under_line" href="#" data-toggle="modal" data-target="#report_already_message" data-title="" style="font-size:11px; margin-top:-3px; float:right;">Report</a>
																	<?php
															}
															else
															{
															?>
														<a class="linkTag under_line" href="<?php echo SERVER_ROOTPATH;?>report.php?rev_id=<?php echo $review_id;?>&num=<?php echo $sr_no;?>" data-toggle="modal" data-target="#report_Modal4_<?php echo $sr_no;?>" data-title="" style="font-size:11px; margin-top:-3px; float:right;">Report</a>											<?php
															}	
                         ...
                         <div class="clearfix"></div>
									...
									<div class="list_item">
                                   	<a href="<?php echo SERVER_ROOTPATH.get_user_detail($user_name).'/profile-review-artist';?>"><img src="<?php echo $prof_image;?>"   width="100" border="0"  ></a>
											<div class="list_bottom" style="padding:2px; width:100px;">
												<div class="row"> 
													<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="padding-left:14px; padding-right:2px;">
                                                   	<a href="<?php echo SERVER_ROOTPATH.get_user_detail($user_name);?>/profile-review-artist"><cite style="margin:2px; font-size:12px; color:#FFFFFF;"><?php echo substr($user_name,0,9);if(strlen($user_name)>9)
									{
										echo "..";
									}?></cite></a>
                                                    </div>
							...
							{
								?> <!--onClick="add_in_favourite_user_profile_list(<?php echo $db_user_id;?>,<?php echo $sr_no;?>)"-->
								<span class="like-group" style="float:right; line-height:20px !important;" id="other_dis_sub_profile_sc_<?php echo $sr_no;?>">
                                 <?php
									  ...
									  {
										?>
									     <a href="javascript:;" onClick="add_in_favourite_user_profile_screen_new('<?php echo $db_user_id;?>','<?php echo $sr_no;?>','<?php echo $user_name;?>')"><i class="fa fa-heart-o heart_color" style="font-size:20px;"></i></a>
										<?php
									  }
									  ?> 
						...
						<?php
							...
							<div class="col-lg-9 col-md-9 col-sm-8 col-xs-9 desc_pan pad_zero mrg_15" style="float:right;">
                             <p class="title" style="margin-bottom:5px;"><span style="background-color:<?php echo $color_pick;?>; border-radius:5px;">
							 <?php if($review_rating==10){echo number_format($review_rating,0);}else { echo $review_rating;}?></span> <a style="color:#000000" href="<?php echo SERVER_ROOTPATH.$song_seo."-reviews-".$artist_seo."#review_".$review_id;?>"><?php 
                                ...
                                <div class="list-inline col-lg-12 col-md-12 col-sm-12 col-xs-12 pad_zero" style="margin-top:10px;">
									...
									<p class="likeVale ccol-lg-3 col-md-3 col-sm-4 col-xs-3 pad_zero" style="font-size:14px; margin-top:-4px;"> 
                                     ...
                                     <?php
												...
												$tm = time();
													...
													if($counter==0)
													{
														?>
                                                         ...
                                                         <span id="other_dis_sub_<?php echo $review_id;?>_<?php echo $tm;?>"><a href="javascript:;" onClick="add_in_favourite_list_review_screen_new('<?php echo $review_id;?>','<?php echo $user_name;?>','<?php echo $k;?>','<?php echo $tm;?>')" class="like" > <i class="fa fa-heart-o heart_color" style="font-size:23px;"></i></a> 
                                                          <span class="text_red"><?php
														  if($review_user_id == $_SESSION[USER_SESSION_ARRAY]['USER_ID'])
														  {
														  	?>
									  ...
									  {
										?>
										<a href="#" data-toggle="modal" data-target="#signin_form"class="text_grey"> <i class="fa fa-heart-o heart_color" style="font-size:23px;"></i> </a>
										<?php
									  }
									  else
									  {
										?>
									  <a href="javascript:;" onClick="add_in_favourite_list_review_screen_new('<?php echo $review_id;?>','<?php echo $user_name;?>','<?php echo $k;?>','<?php echo $tm;?>')" class="text_grey"> <i class="fa fa-heart-o heart_color" style="font-size:23px;"></i> </a>
										<?php
									  }
									  ?> 
                                      <span class="text_red"><?php echo $counter_main_rev;?></span><a href="<?php echo SERVER_ROOTPATH;?>detail_review.php?user=<?php echo urlencode($user_name);?>&review_id=<?php echo $review_id;?>&critaria=1" data-toggle="modal" data-target="#model_review_likes_<?php echo $k;?>" data-title=""  class="like link-disable" style="color:#444;"><?php if($counter_main_rev<2){ echo " Like";} else {  echo " Likes"; }?></a></span>
                                   ...
                                   <?php
												if($db_user_id != $_SESSION[USER_SESSION_ARRAY]['USER_ID'])
												{
													if($_SESSION[USER_SESSION_ARRAY]['USER_ID']=="")
													  {
														?>
														<a href="#" class="linkTag under_line" data-toggle="modal" data-target="#signin_form">Report</a>
														<?php
													  }
													  else
													  {
														if(isset($report_status))
															{
																	?>
																	<a class="linkTag under_line" href="#" data-toggle="modal" data-target="#report_already_message" data-title="">Report</a>
																	<?php
															}
															else
															{
															?>
														 <a class="linkTag under_line" href="<?php echo SERVER_ROOTPATH;?>report.php?rev_id=<?php echo $review_id;?>&num=<?php echo $sr_no;?>" data-toggle="modal" data-target="#report_Modal4_<?php echo $sr_no;?>" data-title="">Report</a>
															<?php
                                                            }	
													  }  
									...
									<p class="col-lg-3 col-md-3 col-sm-12 col-xs-3 pad_zero ft_vall">
										...
										&nbsp; 
										   ...
										   <a href="javascript: popupWindow('http://twitter.com/share?url=<?php echo $url_db;?>&source=<?php echo $title_rev;?>&text=<?php echo substr($review_detail,0,110);?>')"><img src="<?php echo SERVER_ROOTPATH;?>images/tww.png"  width="20"></a>
                                ...
                                <div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 pad_zero">
												...
												if($img_api_linka !=''){
												?>
												 <img src="<?php echo get_small_thumb($img_api_linka);?>"  border="0"  style="height:120px;"/>
                                                <?php } else{ ?>
													...
													{
														?>
														 <img  src="<?php echo get_small_thumb($req_song['song_array']['image4']);?>"  border="0" style="max-width:inherit; height:100px; width:100px;"/>
														<?php														
													}
													else
													if($album_picture!="")
													{
														?>
														 <img src="<?php echo SERVER_ROOTPATH;?>site_upload/album_images/<?php echo 'thumb_'.$album_picture;?>"  border="0" style="max-width:inherit; height:100px; width:100px;"/>
														<?php
													}
													else
													{
														?>
														 <img src="<?php echo SERVER_ROOTPATH;?>assets/images/no_image.png"  border="0"  style="max-width:inherit; height:100px; width:100px;"/>
														<?php
													}
													?></a>
												<?php
								...
								?>
                                 ...
                                 <cite class="score_big mt-10" style="background-color:<?php echo $color_pick;?>"><?php if($all_avg==10){echo number_format($all_avg,0);}else { echo $all_avg;}?></cite>                                           
                                    ...
                                    <?php echo substr($song_title,0,20);if(strlen($song_title)>20)
									{
                                        ...
                                        <label class="author mrg_btm"><a href="<?php echo SERVER_ROOTPATH.get_user_detail($USER_NAME)."-profile-".$artist_seo."-review-albums";?>"><?php echo $artist_name;?></a></label>
                                      ...
                                      <!--  <label class="author pad_left"><?php if($feature_artists!="") {?> <strong class="heart_color">ft.</strong> <?php echo $feature_artists; }?></label><br>-->
                  				...
                  				<div class="rew_list-panel pad_zero" style="margin-top:-15px;">
									<div class="rew_item" style="border:none; padding:18px 0 12px 0;">
							 				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 desc_pan pad_zero">
                                                    <p class="title"> <span style="background-color:<?php echo $color_pick;?>; border-radius:5px; font-size:12px;"><?php if($review_rating==10){echo number_format($review_rating,0);}else { echo $review_rating;}?></span><a href="<?php echo SERVER_ROOTPATH.$song_seo."-reviews-".$artist_seo."#review_".$review_id;?>"><text class="rec_review_title"><?php 
							...
							if($_SESSION[USER_SESSION_ARRAY]['USER_ID']!="")
							{
								...
								{
									?>
									<span class="like-group" style="line-height:0px !important;" id="other_dis_sub_profile_mb_<?php echo $sr_no;?>"><a href="javascript:;" onClick="add_in_favourite_user_profile_mob('<?php echo $db_user_id;?>','<?php echo $sr_no;?>','<?php echo $user_name;?>')"><i class="fa fa-heart" style="color:#d73b3b !important; font-size:14px; margin-top:3px;"></i> </a><a href="<?php echo SERVER_ROOTPATH;?>detail_profile.php?user=<?php echo urlencode($user_name);?>&critaria=1" data-toggle="modal" data-target="#missing_popular_profile_<?php echo $sr_no;?>" data-title=""  class="like link-disable" style="color:#fff; font-size:12px;"> <?php echo $counter_main;?></a></span>
									<span class="like-group" style="line-height:0px !important;" id="myStyle_sub_profile_mb_<?php echo $sr_no;?>"></span>
                                    <?php
								}
							}
							else
							{
								...
								<span class="like-group" style="line-height:20px !important;" id="other_dis_sub_profile_mb_<?php echo $sr_no;?>">
                                 <?php
									  ...
									  {
										?>
										<a href="#" data-toggle="modal" data-target="#signin_form"><i class="fa fa-heart-o heart_color" style="font-size:14px;"></i></a>
										<?php
									  }
									  else
									  {
										?>
									 <a href="javascript:;" onClick="add_in_favourite_user_profile_mob('<?php echo $db_user_id;?>','<?php echo $sr_no;?>','<?php echo $user_name;?>')"><i class="fa fa-heart-o heart_color" style="font-size:14px;"></i></a>
										<?php
									  }
									  ?> 
                                      <a href="<?php echo SERVER_ROOTPATH;?>detail_profile.php?user=<?php echo get_user_detail($user_name);?>&critaria=1" data-toggle="modal" data-target="#missing_popular_profile_<?php echo $sr_no;?>" data-title=""  class="like link-disable" style="color:#fff; font-size:12px;"> <?php echo $counter_main;?></a></span>
								   <span class="like-group" style="line-height:0px !important;" id="myStyle_sub_profile_mb_<?php echo $sr_no;?>"></span>
								...
								$review_list_count_array	=	$db->get_row($userreviews_Query,ARRAY_A);
								?>	                                                                                                                                                                                          </div>
                                                                </div>
                                                            </div>
                                                    </div>
