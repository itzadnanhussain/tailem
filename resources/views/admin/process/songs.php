...
?>
					...
					if($all_avg >=0 && $all_avg <=3.9){$color_pick = "#dd554e";}
                           ...
                           <li <?php if($sr_no%2==0){?> style="background-color:#f3f3f3;"<?php }?>>
 								...
 								<div class="row">
 								    ...
 								    <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12">
 										<div class="album_cover">
  										...
  										<!--	<cite class="yellow">5.0</cite>-->
                                            <?php if($all_avg!=0){
											?><cite style="background-color:<?php echo $color_pick;?>"><?php if($all_avg<10){echo number_format($all_avg,1);}else { echo $all_avg;}?></cite><?php } else { ?> <cite style="background-color:#dd554e;">0.0</cite><?php } ?>
                                        
                                        </div>
 										<div class="album_details">
 											
                                            <label class="title"><a href="<?php echo SERVER_ROOTPATH.$song_seo."-reviews-".$artist_seo;?>">
                                            <?php echo substr($song_title,0,50);if(strlen($song_title)>50)
									{
										echo "...";
									}?>
                                         	...
                                         	<label class="author"><a href="<?php echo SERVER_ROOTPATH.$artist_seo."-artist-songs";?>"><?php echo substr($artist_name,0,30);if(strlen($artist_name)>30)
									{
										echo "...";
 											...
 											<label class="likes" style="height:26px; margin-top:-9px; vertical-align: middle;"><!--<img src="images/icon_heart.png"><a href="#"><span>0</span> Likes</a>-->
                                            <?php
									   			 if($_SESSION[USER_SESSION_ARRAY]['USER_ID']!="")
												{
													...
													if($counter==0)
													{
														?>
                                                          ...
                                                          <a href="<?php echo SERVER_ROOTPATH;?>detail.php?artist=<?php echo $artist_seo;?>&critaria=1" data-toggle="modal" data-target="#artist_modal" data-title=""  class="like link-disable" style="color:#444;"><?php if($counter_main<2){ echo " Likes";} else {  echo " Likes"; }?></a></span>
                             ...
                             <?php
                              ...
                              <span class="text_red"><?php echo $counter_main;?></span>
                                           ...
                                           <span id="myStyle_sub_<?php echo $sr_no;?>_<?php echo $album_artist_id;?>"></span>
                                             ...
                                             <div style="clear:both;"></div>
 											<p>
                                            <label class="reviews"><!--<img src="images/icon_review.png">--> <img src="<?php echo COOKIE_FREE_ROOTPATH; ?>images/review-book.png"><a style="opacity:1;">Reviews <span><?php echo $review_list_arr_top['count_reviews'];?></span></a></label>
                                            <label class="reviews"><img src="<?php echo COOKIE_FREE_ROOTPATH; ?>images/icon_post.png"><a style="opacity:1;"><?php if($comment_list_arr['count_discussion'] < 2){ echo "Posts ";} else {  echo "Posts "; }?><span><?php echo $comment_list_arr['count_discussion'];?></span></label></p>
 										</div>
 							...
 							<?php }elseif($mobile_view == 1){ ?>
								<div class="row">
                               <!-- <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
 										<span class="list_no"><?php if(strlen($k_song)==1){echo "0";}else{};?><?php echo $k_song;?></span>
 									</div>-->
                                     ...
                                     <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 album-detail-container" style="padding:0px !important;">
 										<div class="album_details">
 							                <label class="title"><a href="<?php echo SERVER_ROOTPATH.$song_seo."-reviews-".$artist_seo;?>"><?php echo substr($song_title,0,50);if(strlen($song_title)>50)
									{
										echo "...";
									}?></a></label>
                                         	<label class="author"><a href="<?php echo SERVER_ROOTPATH.$artist_seo."-artist-songs";?>"><?php echo substr($artist_name,0,30);if(strlen($artist_name)>30)
							  ...
							  ?>
                               <span class="text_red"><?php echo $counter_main;?></span>
                                           ...
                                           <span id="myStyle_sub_<?php echo $sr_no;?>_<?php echo $album_artist_id;?>"></span>
                                            ...
                                            <label class="reviews"><img src="<?php echo COOKIE_FREE_ROOTPATH;?>images/icon_post.png"><a><?php if($comment_list_arr['count_discussion'] < 2){ echo "Posts ";} else {  echo "Posts "; }?><span><?php echo $comment_list_arr['count_discussion'];?></span></a></label></p>
										</div>
	...
	.album_details label > span{ overflow:visible; }
	
	@media (max-width: 350px){
	<!--.topsonglistsec .songlistings li{padding: 5px 15px;}-->
	.banner.topsongbanner {background: rgba(0, 0, 0, 0) url("<?php echo COOKIE_FREE_ROOTPATH; ?>images/banner_topsongs_mobile.png") no-repeat scroll 0 0 / cover !important;
	height: 236px;}
	}
