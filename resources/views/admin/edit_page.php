                      ...
                      <tr>
                        <td class="body">
                            ...
                            <table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tbody>
                                <tr>
                                  <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a href="<?php echo SERVER_ADMIN_PATH;?>page_list.php">Pages Listing</a> &raquo; <a>Edit Pages</a></td>
                                </tr>
                                <tr>
