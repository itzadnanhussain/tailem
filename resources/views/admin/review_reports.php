...
if(isset($_POST['Reset']))
{
	...
	header("Location:review_reports.php?key=".$_REQUEST['key']."");
}
...
<table style="border-collapse: collapse;" border="0" cellpadding="0" width="100%" height="100%">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo;  <a href="<?php echo SERVER_ADMIN_PATH;?>reviews_list.php">Review Listing</a> &raquo; <a>Review Report Listing</a></td>
                              </tr>
							  <?php
                              $key  = $_REQUEST['key'];
                                    ...
                                    style="border:1px solid #000000; padding:10px;">
                                        <tbody>
                                            ...
                                            <tr height="30">
                                                ...
                                                <td align="center">
                                                <input name="rreport_details" id="rreport_details" class="Field300" 
                                                value="<?php echo $_SESSION['rreport_details_sess'];?>" type="text"/>
                                                </td>
                                            </tr>
                                            <tr height="30">
                                                <td class="SmallFieldLabelnew font_bold" align="left"  width="150"> 
                                                ...
                                                <td align="center">
                                               	<select name="rreport_user_id" id="rreport_user_id" 
                                ...
                                <table cellpadding="0" cellspacing="0" class="Panel">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <a href="review_reports.php?sortby=user_asc&page=<?php echo $page;?>&key=<?php echo $key;?>" class="link_class">Report User</a>
                                        <?php }else{?>
                                        <a href="review_reports.php?sortby=user_desc&page=<?php echo $page;?>&key=<?php echo $key;?>" class="link_class">Report User</a>
                                        <?php }?>
                                        </td>
									  ...
									  <form action="<?php echo SERVER_ADMIN_PATH; ?>process/review_report_actions.php" method="post" id="report_form">
									  <?php
    ...
    &nbsp;&nbsp; <input type="checkbox" class="check-all" name="r_report_ids[]" id="r_report_ids[]" value="<?php echo base64_encode($r_report_id);?>" style="margin-top:-5px;" />
									...
									?>
									  ...
									  ?>
									  <tr>
                                        <td colspan="5" align="center" valign="middle"><?php include("common/report_paging.php"); ?></td>
                                      </tr>
									  </form>
