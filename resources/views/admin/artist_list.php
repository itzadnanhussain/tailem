...
if(isset($_POST['filter']))
{
	...
	if($_REQUEST['artist_itunesid']!=""){
		...
		$sess_where .= " and id  = ".$_REQUEST['artist_itunesid']."";
		 ...
		 $_SESSION['artist_itunesid_sess'] = $_REQUEST['artist_itunesid_sess'];
 	...
 	//	 $_SESSION['where_query'] = $where_search;
		...
		unset($_SESSION['artist_itunesid_sess']);
	}
...
//echo "ram1";
//echo $session_where = $_SESSION['sess_song_query'];
...
//$orderby = " ORDER BY   artist_status desc , LOCATE('".$_SESSION['artist_name_sess']."', artist_name) desc ";

$orderby = "  ORDER BY artist_status desc , CASE WHEN artist_name = '".$_SESSION['artist_name_sess']."' THEN 0  
              WHEN artist_name LIKE '".$_SESSION['artist_name_sess']."%' THEN 1  
              WHEN artist_name LIKE '%".$_SESSION['artist_name_sess']."%' THEN 2  
              WHEN artist_name LIKE '%".$_SESSION['artist_name_sess']."' THEN 3  
              ELSE 4
         END, artist_name ASC ";
...
$sr_no = 0;
	...
	{
		// $sess_artist_name_query .= " and artist_name  like \"%".trim($_SESSION['artist_name_sess'])."%\" ";
		  $sess_artist_name_query .= " and  MATCH (artist_name) AGAINST ('*".trim($_SESSION['artist_name_sess'])."*' IN BOOLEAN MODE) ";
	...
	if($_SESSION['artist_status'] != "")
	{
		$sess_artist_status_query .= " and artist_status = '".$_SESSION['artist_status']."'";
		//$_SESSION['artist_status'] = $_REQUEST['artist_status'];
	}
...
if($_SESSION['artist_name_sess'] !="" || $_SESSION['artist_status'] != "")
	{
		$session_where .= "  $orderby limit $start, $limit ";
	}else{

		$session_where .= " and ids > $start $orderby limit $limit ";
	}
$_SESSION['sess_song_query'] = $session_where;
//echo "ram2";
 $session_where = $_SESSION['sess_song_query']; 
 //echo "</br>";
                                        ...
                                        <tbody>
                                            <tr>
                                             ...
                                             <tr height="30">
                                                ...
                                                <td align="center">
                                                    <input name="artist_itunesid" id="artist_itunesid" type="text" class="Field300" 
                                                    value="<?php echo $_SESSION['artist_itunesid_sess']; ?>" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr height="30">
                                                ...
                                                <td align="center">
                                                    ...
                                                    value="<?php echo $_SESSION['artist_name_sess']; ?>" />
                                                </td>
                                            </tr>
                                            <tr height="30">
                                                <td class="SmallFieldLabelnew font_bold" align="left"  width="150"> 
                              ...
                              <tr>
                                ...
                                <table cellpadding="0" cellspacing="0" class="Panel">
									...
									if($artist_img!="")
                                        ...
                                        <td nowrap="nowrap" class="SmallFieldLabel" width="200">
										<a href="view_artist.php?iTunesid=<?php echo $id; ?>"><?php echo $artist_name;?></a>
										 &raquo; 
										 <a href="<?php echo SERVER_ROOTPATH.$artist_seo."-preview-artist";?>" target="blank">Preview</a>
                                        </td>
