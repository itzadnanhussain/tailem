...
if(isset($_POST['Reset']))
{
	...
	unset($_SESSION['review_level5_cat_id_sess']);
	$_SESSION['review_level5_cat_id_sess']="";
...
if(isset($status) && !empty($status))
{
	...
	$db->query($sqlquery);
	header("Location:reviews_list.php?msg=$update_ok_msg&case=1");
	exit;
}
?>
<html>
...
<table style="border-collapse: collapse;" border="0" cellpadding="0" width="100%" height="100%">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a>Reviews Listing</a></td>
                              </tr>
                              <tr>
                                <td>
                                ...
                                <table cellpadding="0" cellspacing="0" class="Panel">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <a href="reviews_list.php?sortby=title_asc&page=<?php echo $page;?>" class="link_class">Review Title</a>
                                        <?php }else{?>
                                        <a href="reviews_list.php?sortby=title_desc&page=<?php echo $page;?>" class="link_class">Review Title</a>
                                        <?php }?>
                                        </td>
                                        <td width="150" id="Heading_list">
                                       <a style="text-decoration:none;" class="link_class">Song Title</a>
                                        ...
                                        <a href="reviews_list.php?sortby=rating_asc&page=<?php echo $page;?>" class="link_class">Review Rating</a>
                                        <?php }else{?>
                                        <a href="reviews_list.php?sortby=rating_desc&page=<?php echo $page;?>" class="link_class">Review Rating</a>
                                        <?php }?>
                                        </td>
                                        <td width="150" id="Heading_list">
                                        <?php if($sortby == 'user_id_desc'){?>
                                        <a href="reviews_list.php?sortby=user_id_asc&page=<?php echo $page;?>" class="link_class">User Name</a>
                                        <?php }else{?>
                                        <a href="reviews_list.php?sortby=user_id_desc&page=<?php echo $page;?>" class="link_class">User Name</a>
                                        <?php }?>
                                        </td>
                                        ...
                                        <a href="reviews_list.php?sortby=date_asc&page=<?php echo $page;?>" class="link_class">Post Date</a>
                                        <?php }else{?>
                                        <a href="reviews_list.php?sortby=date_desc&page=<?php echo $page;?>" class="link_class">Post Date</a>
                                        <?php }?>
                                        </td>
                                        <td width="50" id="Heading_list">Likes<br> Reports</td>
                                        <td width="70" id="Heading_list">
                                        <?php if($sortby == 'statusdesc'){?>
                                        <a href="reviews_list.php?sortby=statusasc&page=<?php echo $page;?>" class="link_class">Status</a>
                                        <?php }else{?>
                                        <a href="reviews_list.php?sortby=statusdesc&page=<?php echo $page;?>" class="link_class">Status</a>
                                        <?php }?>
                                        </td>
									  ...
									  <?php
										 ...
										 $session_where $orderby";
											...
											$targetpage = "reviews_list.php"; //your file name  (the name of this file)
									  ...
									  <tr bgcolor="<?php echo $bgcolor; ?>" onMouseOver="changebackcolor_hover('row<?php echo $review_id;?>')" onMouseOut="changebackcolor_blur('row<?php echo $review_id;?>')" id="row<?php echo $review_id;?>">
										...
										if($status==1)
										{
										  ...
										  <?php
											if($status==0)
											{
												echo '<a href="reviews_list.php?status='.base64_encode(1).'&status_id='.base64_encode($review_id).'"><img src="images/disable.gif" border="0" class="Action" title="Activate"></a>'; 
											}
											if($status==1)
											{
												echo '<a href="reviews_list.php?status='.base64_encode(0).'&status_id='.base64_encode($review_id).'"><img src="images/enable.gif" border="0" class="Action" title="Blocked"></a>'; 
											}
    ...
    &nbsp;&nbsp; <input type="checkbox" class="check-all" name="review_ids[]" id="review_ids[]" value="<?php echo base64_encode($review_id);?>" style="margin-top:-5px;" />
										...
										{
										?>	
                                        <a href="edit_review.php?edit_id=<?php echo base64_encode($review_id);?>"><img src="images/edit.gif" border="0" title="Edit" class="Action"></a>
                                        <?php
										}
										?>&nbsp;&nbsp;	
                                        <?php
