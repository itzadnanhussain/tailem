...
include("includes/operations/myaccount_op.php");
							  ...
							  <table class="Panel">
								<tbody>
								  ...
								  <tr>
									...
									<td width="81%">
                                      <input name="site_mode" id="site_mode" value="1" type="radio" <?php if($site_mode==1){ echo "checked='checked'";}?> /> <strong>Live Mode</strong>
                                      <input name="site_mode" id="site_mode" value="2" type="radio" <?php if($site_mode==2){ echo "checked='checked'"; }?> /> <strong>Maintenance Mode</strong>
                                    </td>
								  </tr>
								  <tr>
									<td>&nbsp;</td>
