                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a href="<?php echo SERVER_ADMIN_PATH;?>song_list.php">Songs Listing</a>&raquo; <a href="<?php echo SERVER_ADMIN_PATH;?>artist_list_song.php?song_id=<?php echo $song_id;?>"><?php echo stripslashes($song_list_arr['song_title']);?></a>
                                    ...
                                    <tbody>
									  ...
									  <tr>
										  <td colspan="6" width="105" align="right" valign="middle" id="addsymbol" >
											<a href="<?php echo SERVER_ADMIN_PATH; ?>addedit_song_artist_album.php?song_id=<?php echo $song_id;?>&artist_id=<?php echo $artist_id;?>"><img src="images/add.png" border="0" title="Add/Edit Album"></a>
                                          </td>
									  </tr>
