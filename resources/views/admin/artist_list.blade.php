																	...
																	<tr height="30">
																		...
																		<td align="center">
																			<input name="artist_name" id="artist_name"
																				...
																				value="<?php echo session()->get('artist_name_sess'); ?>" />
																		</td>
																	</tr>
																	<tr height="30">
																		<td class="SmallFieldLabelnew font_bold"
																		...
																		<td align="center">
																			<select name="artist_status"
																				id="artist_status" class="Field300">
															...
															<tbody>
																...
																<tr>
																	...
																	<td width="200" id="Heading_list">
																		...
																		<a href="artist_list?sortby=artist_name_asc&page=<?php echo $page; ?>"
																			class="link_class">Artist</a>
																		<?php } else { ?>
																		<a href="artist_list?sortby=artist_desc&page=<?php echo $page; ?>"
																			class="link_class">Artist</a>
																		<?php } ?>
																	</td>
																	...
																	<td width="70" id="Heading_list">
																		...
																		<a href="artist_list?sortby=statusasc&page=<?php echo $page; ?>"
																			class="link_class">Status</a>
																		<?php } else { ?>
																		<a href="artist_list?sortby=statusdesc&page=<?php echo $page; ?>"
																			class="link_class">Status</a>
																		<?php } ?>
																	</td>
																...
																<form
																	...
																	<tr bgcolor="<?php echo $bgcolor; ?>"
																		...
																		<td nowrap="nowrap" class="SmallFieldLabel"
																			width="200">
																			<a
																				href="view_artist?iTunesid=<?php echo $id; ?>"><?php echo $artist_name; ?></a>
																			&raquo;
