...
if($edit_id!="")
{
	...
	$row  =  $db->get_row("select review_id, review_title, review_detail, review_rating, review_user_id from tbl_reviews where review_id='".$edit_id."' ",ARRAY_A);
...
?>
	<script>
		window.location.href='<?php echo SERVER_ADMIN_PATH;?>reviews_list.php'; 
	</script>
<?php
}
