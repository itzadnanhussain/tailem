...
<table style="border-collapse: collapse;" border="0" cellpadding="0" width="100%" height="100%">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a>  &raquo; <a><a>Discussions Listing</a></td>
                              </tr>
                              <tr>
                                <td>
                                    ...
                                    style="border:1px solid #000000; padding:10px;">
                                        <tbody>
                                            ...
                                            <tr height="30">
                                                ...
                                                <td align="center">
                                                <input name="gcomment_detail" id="gcomment_detail" class="Field300" 
                                                value="<?php echo $_SESSION['gcomment_detail_sess'];?>" type="text"/>
                                                </td>
                                            </tr>
                                            <tr height="30">
                                                <td class="SmallFieldLabelnew font_bold" align="left"  width="150"> 
                                                ...
                                                <td align="center">
                                               	<select name="gcomment_user_id" id="gcomment_user_id" 
                                ...
                                <table cellpadding="0" cellspacing="0" class="Panel">
                                    <tbody>
									  ...
									  <?php
											...
											$targetpage = "gcomments.php"; //your file name  (the name of this file)
									  ...
									  <tr bgcolor="<?php echo $bgcolor; ?>" onMouseOver="changebackcolor_hover('row<?php echo $gcomment_id;?>')" onMouseOut="changebackcolor_blur('row<?php echo $gcomment_id;?>')" id="row<?php echo $gcomment_id;?>">
                                        ...
                                        <td nowrap="nowrap" class="SmallFieldLabel" width="60">
											Reports = <a href="<?php echo SERVER_ADMIN_PATH;?>gcomments_reports.php?key=<?php echo base64_encode($gcomment_id);?><?php echo $url_path?>" style="text-decoration:none;color:#0000FF;"><strong><?php echo $total_reports;?></strong></a>
                                        </td>
    ...
    &nbsp;&nbsp; <input type="checkbox" class="check-all" name="gcomment_ids[]" id="gcomment_ids[]" value="<?php echo base64_encode($gcomment_id);?>" style="margin-top:-5px;" />
    									 &nbsp; &nbsp;
                                        <a href="edit_discussion.php?edit_id=<?php echo base64_encode($gcomment_id);?>"><img src="images/edit.gif" border="0" title="Edit" class="Action"></a>
                                        &nbsp; &nbsp;
