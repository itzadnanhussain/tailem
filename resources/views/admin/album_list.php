...
//PAGGING CODE STARTS HERE
	...
	$targetpage = "album_list.php"; //your file name  (the name of this file)
...
//PAGGING CODE STARTS HERE
	...
	$c=1;
  	$artist_list="select b.ids, b.id, b.album_title, b.album_picture, b.popular_album, a.artist_name, b.album_status, b.album_artist_id FROM tbl_artist_album b, tbl_artists a where 1=1 AND b.album_artist_id = a.id $session_where $orderby LIMIT $start, $limit";	
...
$sr_no = 0;
 ...
 $session_where =  $sess_album_title_query.$sess_artist_title_query.$sess_album_status_query; echo "</br>";
 ...
 if($_SESSION['album_title_sess'] !="" || $_SESSION['artist_title_sess'] != "" || $_SESSION['album_status'] != "")
	{
		...
		$session_where .= " and b.ids > $start $orderby limit $limit ";
	}
...
$c=1;
 $artist_list="select b.ids, b.id, b.album_title, b.album_picture, b.popular_album, a.artist_name, b.album_status, b.album_artist_id FROM tbl_artist_album b, tbl_artists a where 1=1 AND b.album_artist_id = a.id $session_where";	
...
$c=1;
 $artist_list="select b.ids, b.id, b.album_title, b.album_picture, b.popular_album, a.artist_name, b.album_status, b.album_artist_id FROM tbl_artist_album b, tbl_artists a where b.album_artist_id = a.id LIMIT $start, $limit";	
...
if(isset($status) && !empty($status))
{
	...
	$db->query($sqlquery);
	header("Location:album_list.php?artist_id=$artist_id&msg=$update_ok_msg&case=1");
	exit;
}
?>
<html>
                                        ...
                                        <tbody>
                                            ...
                                            <tr height="30">
                                               ...
                                               Album iTunes id
                                                ...
                                                <td align="center">
                                                    <input name="album_itunesid" id="album_itunesid" type="text" class="Field300" 
                                                    value="<?php echo $_SESSION['album_itunesid_sess']; ?>" />
                                                </td>
                                            </tr>
                                             ...
                                             <tr height="30">
                                               ...
                                               Artist
                                                ...
                                                <td align="center">
                                                    <input name="artist_title" id="artist_title" type="text" class="Field300" 
                                                    value="<?php echo $_SESSION['artist_title_sess']; ?>" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr height="30">
                                                ...
                                                <select name="album_status" id="album_status" class="Field300">
                                                    ...
                                                    <option value="1" <?php if($_SESSION['album_status'] == '1'){ echo 'selected="selected"';}?>>Active</option>
                                                    <option value="0" <?php if($_SESSION['album_status'] == '0'){ echo 'selected="selected"';}?>>Block</option>	
                                                 </select>
                                                 </td>
                                            </tr>
                              ...
                              <tr>
                                ...
                                <table cellpadding="0" cellspacing="0" class="Panel">
                                    <tbody>
                                      ...
                                      <tr>
                                       ...
                                       <!--<td width="100" id="Heading_list"> <?php if($sortby == 'ranking_order_asc'){?>
                                        <a href="album_list.php?sortby=ranking_order_desc&page=<?php echo $page;?>" class="link_class">Ranking</a>
                                        <?php }else{?>
                                        <a href="album_list.php?sortby=ranking_order_asc&page=<?php echo $page;?>" class="link_class">Ranking</a>
                                        <?php }?></td>-->
                                      ...
                                      <form action="<?php echo SERVER_ADMIN_PATH; ?>process/album_actions2.php" method="post" id="faq_form">
								  ...
								  <?php		
									...
									<td nowrap="nowrap" class="SmallFieldLabel" width="200">
										<a href="artist_album_songs_list.php?artist_id=<?php echo base64_encode($artist_id);?>&album_id=<?php echo base64_encode($id);?>"><?php echo $album_title;?></a>
									</td>
                                    ...
                                    <td nowrap="nowrap" class="SmallFieldLabel" width="200">
										 <a href="artist_album_list.php?artist_id=<?php echo base64_encode($artist_id);?>"><?php echo $artist_name;?></a>
									</td>
...
&nbsp;&nbsp; <input type="checkbox" class="check-all" name="ids[]" id="ids[]" value="<?php echo base64_encode($id);?>" style="margin-top:-5px;" />
									&nbsp;&nbsp;	
                                     <a href="addedit_artist_album.php?edit_id=<?php echo base64_encode($id);?>&artist_id=<?php echo base64_encode($artist_id);?>"><img src="images/edit.gif" border="0" title="Edit" class="Action"></a>	
                                      &nbsp;&nbsp;
                                      <?php
											if($status==0)
											{
