	...
	?>
        ...
        <div class="row">
                	...
                	<div class="col-sm-3">
                    	<div class="clearfix display_mobile">
                        	<div class="pull-right text-right">
                                <span class="score_big mb-10" style="background-color:<?php echo $color_pick;?>"><?php if($all_avg==10){echo number_format($all_avg,0);}else { echo $all_avg;}?></span><br>
                                   <?php
		   if($_SESSION[USER_SESSION_ARRAY]['USER_ID']!="")
			{
				...
				if($counter1==0)
				{
					?>
                      ...
                      <a href="<?php echo SERVER_ROOTPATH;?>detail.php?artist=<?php echo $artist_seo;?>&critaria=1" data-toggle="modal" data-target="#missing_store_detail_Modal3_<?php echo $artist_id;?>" data-title=""   style="color:#444;" class="text_blck link-disable"><?php if($counter_main<2){ echo " Like";} else {  echo " Likes"; }?></a></span>
		 ...
		 ?>
                             ...
                             <a href="<?php echo SERVER_ROOTPATH.$song_seo."-reviews-".$artist_seo.".html";?>" style="text-decoration:none;"><h2 class="mt-0"><?php echo $song_title;?></h2></a>
                           <a href="<?php echo SERVER_ROOTPATH.$artist_seo."-artist.html";?>" class="text_grey"><h2 class="text_grey"><?php echo $artist_name;?></h2></a>  
                            <div class="clear"></div>
                	...
                	<tbody>
                      <tr style="height:10px;">
                        ...
                        <td>
                            <a href="<?php echo SERVER_ROOTPATH.$song_seo?>-reviews-<?php echo $artist_seo;?>-rating-excellent.html"><div class="progress mb-0" style="cursor:pointer;">
                      ...
                      <tr>
                        <td>Very Good</td>
                        <td>
                            <a href="<?php echo SERVER_ROOTPATH.$song_seo?>-reviews-<?php echo $artist_seo;?>-rating-verygood.html"><div class="progress mb-0" style="cursor:pointer;">
                      ...
                      <tr>
                        <td>Average</td>
                        <td>
                              <a href="<?php echo SERVER_ROOTPATH.$song_seo?>-reviews-<?php echo $artist_seo;?>-rating-average.html"><div class="progress mb-0" style="cursor:pointer;">
                      ...
                      <tr>
                        <td>Poor</td>
                        <td>
                            <a href="<?php echo SERVER_ROOTPATH.$song_seo?>-reviews-<?php echo $artist_seo;?>-rating-poor.html"><div class="progress mb-0" style="cursor:pointer;">
                      ...
                      <tr>
                        <td>Terrible</td>
                        <td>
                             <a href="<?php echo SERVER_ROOTPATH.$song_seo?>-reviews-<?php echo $artist_seo;?>-rating-terrible.html"><div class="progress mb-0" style="cursor:pointer;">
		 ...
		 ?>
                           ...
                           <div class="col-sm-9" style="padding:0;">
                            ...
                            <?php if($feature_artists!="") {?> <strong>ft.</strong> <?php echo $feature_artists; }?></h3>
                            </div>
							...
							?> <br><a href="<?php echo $song_url_fm;?>"><img border="0" src="<?php echo SERVER_ROOTPATH;?>images/fm.png"></a><?php }else{echo $description;}?></p>
                        </div>
                        <?php 
                ...
                <div class="row" id="review_focus">
                    <div class="col-sm-6"><h2>REVIEWS </h2></div>
						...
						$query_likes_count_all  	=  count($db->get_results("select u.user_name, u.profile_image from tbl_likes l, tbl_users u where u.user_id = l.like_id AND l.like_id = $review_user_id AND l.like_type = 'profile'",ARRAY_A));
							...
							if($_SESSION[USER_SESSION_ARRAY]['USER_ID']!="")
							{
								...
								if($counter==0)
								{
									...
									<a href="<?php echo SERVER_ROOTPATH;?>detail_profile.php?user=<?php echo $db_user_name;?>&critaria=1" data-toggle="modal" data-target="#missing_popular_profile_<?php echo $prof_counter;?>" data-title="" class="like text_grey link-disable" style="color:#ccc;margin-left:2px;" ><?php if($counter_main<2){ echo " Like";} else {  echo " Likes"; }?></a></span>
							...
							if($_SESSION[USER_SESSION_ARRAY]['USER_ID']!="")
							{
								...
								if($counter==0)
								{
									  ...
									  <a href="<?php echo SERVER_ROOTPATH;?>detail_review.php?user=<?php echo $db_user_name;?>&review_id=<?php echo $db_review_id;?>&critaria=1" data-toggle="modal" data-target="#model_review_likes_<?php echo $k;?>" data-title=""  class="like link-disable" style="color:#444;"><?php if($counter_main<2){ echo " Like";} else {  echo " Likes"; }?></a></span>
							...
							else
							{
								...
								?>
                             <span class="scors" style="background-color:<?php echo $color_pick;?>"><?php if($db_review_rating==10){echo number_format($db_review_rating,0);}else { echo $db_review_rating;}?></span>
                                    </span>
									</span>
								</div>	
                            ...
                            <div class="col-sm-4">
                                <div class="img_cont">
                                   <a href="<?php echo SERVER_ROOTPATH.$song_seo."-reviews-".$artist_seo.".html";?>">  <?php
                                    ...
                                    <?php
									 if($all_avg!=0){
														?><span class="score" style="background-color:<?php echo $color_pick;?>"><?php if($all_avg<10){echo number_format($all_avg,1);}else { echo $all_avg;}?></span><?php } else { ?> <span class="score">5.0</span><?php } ?>
                                    <div class="title">
										 ...
										 if($_SESSION[USER_SESSION_ARRAY]['USER_ID']!="")
							 {
								...
								if($counter==0)
								{
									?>
									  ...
									  <a href="<?php echo SERVER_ROOTPATH;?>detail.php?artist=<?php echo $artist_seo;?>&critaria=1" data-toggle="modal" data-target="#missing_popular_review_Modal2_<?php echo $p_fav;?>" data-title="" class="link-disable" ><?php if($counter_main<2){ echo " Like";} else {  echo " Likes"; }?></a>
                                      </span>
								...
								else
								{
									...
									<a href="<?php echo SERVER_ROOTPATH;?>detail.php?artist=<?php echo $artist_seo;?>&critaria=1" data-toggle="modal" data-target="#missing_popular_review_Modal2_<?php echo $p_fav;?>" data-title="" ><?php if($counter_main<2){ echo " Like";} else {  echo " Likes"; }?></a></span>
							 ...
							 {
								?>
								   <a href="<?php echo SERVER_ROOTPATH;?>detail.php?artist=<?php echo $artist_seo;?>&critaria=1" data-toggle="modal" data-target="#missing_popular_review_Modal2_<?php echo $p_fav;?>" data-title=""  class="like link-disable" style="margin-left:4px;"> <span><?php echo $counter_main;?></span> <?php if($counter_main<2){ echo " Like";} else {  echo " Likes"; }?></a>
