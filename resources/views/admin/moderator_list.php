...
if(isset($status) && !empty($status))
{
	...
	$db->query($sqlquery);
	header("Location:moderator_list.php?msg=$update_ok_msg&case=1");
	exit;
}
?>
<html>
...
<table style="border-collapse: collapse;" border="0" cellpadding="0" width="100%" height="100%">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a>Moderator Listing</a></td>
                              </tr>
                              <tr>
                                <td>
                                    ...
                                    style="border:1px solid #000000; padding:10px;">
                                        <tbody>
                                            ...
                                            <tr height="30">
                                                ...
                                                <td align="center">
                                                    <input name="username" id="username" type="text" class="Field300" 
                                                    value="<?php echo $_SESSION['moderator_name_sess']; ?>" />
                                                </td>
                                            </tr>
                                            <tr height="30">
                                                <td class="SmallFieldLabelnew font_bold" align="left" width="150">
                                                ...
                                                <td align="center">
                                                    <input name="email" id="email" class="Field300" type="text"
                                                    value="<?php echo $_SESSION['moderator_email_sess']; ?>" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr height="30">
                                                ...
                                                <select name="moderator_status" id="moderator_status" class="Field300">
                                                    ...
                                                    <option value="1" <?php if($_SESSION['moderator_status_sess'] == '1'){ echo 'selected="selected"';}?>>Active</option>
                                                    <option value="0" <?php if($_SESSION['moderator_status_sess'] == '0'){ echo 'selected="selected"';}?>>Block</option>	
                                                 </select>
                                                 </td>
                                            </tr>
                                    ...
                                    <tbody>
									  ...
									  <tr>
										  <td colspan="8" width="105" align="right" valign="middle" id="addsymbol" >
											<a href="<?php echo SERVER_ADMIN_PATH; ?>addedit_moderator.php"><img src="images/add.png" border="0" title="Add New Subject"></a>
                                          </td>
									  </tr>
                                      ...
                                      <tr>
                                        ...
                                        <a href="moderator_list.php?sortby=name_asc&page=<?php echo $page;?>" class="link_class">User Name</a>
                                        <?php }else{?>
                                        <a href="moderator_list.php?sortby=name_desc&page=<?php echo $page;?>" class="link_class">User Name</a>
                                        <?php }?>
                                        </td>
                                        
                                        <td width="150" id="Heading_list">
                                        <?php if($sortby == 'email_desc'){?>
                                        <a href="moderator_list.php?sortby=email_asc&page=<?php echo $page;?>" class="link_class">User Email</a>
                                        <?php }else{?>
                                        <a href="moderator_list.php?sortby=email_desc&page=<?php echo $page;?>" class="link_class">User Email</a>
                                        <?php }?>
                                        </td>
                                        
                                        <td width="50" id="Heading_list">
                                        <?php if($sortby == 'statusdesc'){?>
                                        <a href="moderator_list.php?sortby=statusasc&page=<?php echo $page;?>" class="link_class">Status</a>
                                        <?php }else{?>
                                        <a href="moderator_list.php?sortby=statusdesc&page=<?php echo $page;?>" class="link_class">Status</a>
                                        <?php }?>
                                        </td>
									  ...
									  <form action="<?php echo SERVER_ADMIN_PATH; ?>process/moderator_actions.php" method="post" id="moderator_form">
									  <?php
										...
										$moderator_arr	=	$db->get_results($moderator_qry,ARRAY_A);
									  ...
									  <tr bgcolor="<?php echo $bgcolor; ?>" onMouseOver="changebackcolor_hover('row<?php echo $id;?>')" onMouseOut="changebackcolor_blur('row<?php echo $id;?>')" id="row<?php echo $id;?>">
										...
										if($admin_status==1)
										{
										  ...
										  <?php
											if($admin_status==0)
											{
												echo '<a href="moderator_list.php?status='.base64_encode(1).'&status_id='.base64_encode($id).'"><img src="images/disable.gif" border="0" class="Action" title="Activate"></a>'; 
											}
											if($admin_status==1)
											{
												echo '<a href="moderator_list.php?status='.base64_encode(0).'&status_id='.base64_encode($id).'"><img src="images/enable.gif" border="0" class="Action" title="Blocked"></a>'; 
											}
    ...
    &nbsp;&nbsp; <input type="checkbox" class="check-all" name="ids[]" id="ids[]" value="<?php echo base64_encode($id);?>" style="margin-top:-5px;" />
										&nbsp;&nbsp;	
                                        <a href="addedit_moderator.php?edit_id=<?php echo base64_encode($id);?>"><img src="images/edit.gif" border="0" title="Edit" class="Action"></a>
                                        ...
                                        &nbsp; &nbsp;
                                         <a href="moderator_rights.php?edit_id=<?php echo base64_encode($id);?>"><img src="images/setting.png" border="0" title="Assign Right" class="Action" ></a>
                                        </td>
                                      </tr>
                                      <?php
											}
