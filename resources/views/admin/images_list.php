                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a>Image Listing</a></td>
                              </tr>
                              
                               <tr>
										  <td colspan="7" width="105" align="right" valign="middle" id="addsymbol" >
									
                                       <!-- <a href="<?php echo SERVER_ADMIN_PATH; ?>store_images.php"><img src="images/add.png" border="0" title="Add New"></a>-->
                              ...
                              <tr>
                                ...
                                <table cellpadding="0" cellspacing="0" class="Panel">
									...
									if($store_img!="")
                                        ...
                                        <a href="store_images.php?edit_id=<?php echo base64_encode($store_id);?>"><img src="images/edit.gif" border="0" title="Edit"></a></td>
