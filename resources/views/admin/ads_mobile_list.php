                                            ...
                                            <!--<tr height="30">
                                                ...
                                                <td align="center">
                                                    <select name="ads_place" id="ads_place" class="Field300">
                                                        ...
                                                        <option value="Top" <?php if($_SESSION['ads_place_sess']=="Top"){ echo "selected='selected'";}?>>Top</option>
                                                        <option value="Bottom" <?php if($_SESSION['ads_place_sess']=="Bottom"){ echo "selected='selected'";}?>> Bottom</option>
                                                </select>
                                                </td>
                                            </tr>-->
                                            <tr height="30">
                                                ...
                                                <select name="ads_status" id="ads_status" class="Field300">
                                                    ...
                                                    <option value="1" <?php if($_SESSION['status_ads_sess'] == '1'){ echo 'selected="selected"';}?>>Active</option>
                                                    <option value="0" <?php if($_SESSION['status_ads_sess'] == '0'){ echo 'selected="selected"';}?>>Block</option>	
                                                 </select>
                                                 </td>
                                            </tr>
