...
<table style="border-collapse: collapse;" border="0" cellpadding="0" width="100%" height="100%">
	<tbody>
										...
										<td class="body">
											<table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
											  <tbody>
												<tr>
												  <td align="left">
												 <a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a href="<?php echo SERVER_ADMIN_PATH;?>song_list.php">Songs Listing</a>&raquo; <a href="<?php echo SERVER_ADMIN_PATH;?>artist_list_song.php?song_id=<?php echo $song_id;?>"><?php echo stripslashes($song_list_arr['song_title']);?></a>
                               
                                 &raquo; <a><?php echo stripslashes($song_list_arr['artist_name']);?>
                                  &raquo; <a>Add Album (<a href="<?php echo SERVER_ADMIN_PATH;?>artist_album_list.php?artist_id=<?php echo $artist_id;?>" target="_blank" style="text-decoration:none; color:#0000CC">View <?php echo stripslashes($song_list_arr['artist_name']);?> album</a>)</a>
        ...
        <?php
								...
								$album_list_arr	=	$db->get_results($album_list,ARRAY_A);
