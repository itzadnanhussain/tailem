...
$get_lnks_arr	=	$db->get_row($get_lnks_qry,ARRAY_A);
							  ...
							  <table class="Panel" style="width:1300px;">
								<tbody>
								  ...
								  <tr>
									<td>&nbsp;</td>
									<td>
                                    	<input name="update_links" id="update_links" value="Update" class="FormButton" type="submit" onClick="validate_social_links();">                        </td>
								  </tr>
								</tbody>
							  </table>						  
						  </form>						  </td>
