  ...
  <tbody>
    <tr>
       <td width="30%" valign="top" style="padding-top:0px; padding-left:20px;">
			...
			<font style="color:#FFFFFF;" onmouseover="this.style.cursor='pointer'" onclick="window.location='<?php echo SERVER_ADMIN_PATH;?>index.php'"><?php echo PAGE_TITLE;?></font>
		</div>
	  </td>
      <td class="textlinks" align="right" width="70%" style="padding-top:10px;"><span class="MenuText">
			...
			<span class="MenuText">
				...
				<span class="MenuText"><a href="<?php echo SERVER_ADMIN_PATH;?>setting.php" class="MenuText">Setting</a>&nbsp;&nbsp;|&nbsp;&nbsp;
