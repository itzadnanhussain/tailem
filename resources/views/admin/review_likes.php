...
if(isset($_POST['Reset']))
{
	...
	header("Location:review_likes.php?key=".$_REQUEST['key']."");
}
...
<table style="border-collapse: collapse;" border="0" cellpadding="0" width="100%" height="100%">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a>&raquo; <a href="<?php echo SERVER_ADMIN_PATH;?>reviews_list.php">Review Listing</a>&raquo; <a>Review Likes Listing</a></td>
                              </tr>
							  <?php
                              $key  = $_REQUEST['key'];
                                    ...
                                    style="border:1px solid #000000; padding:10px;">
                                        <tbody>
                                            ...
                                            <tr height="30">
                                                ...
                                                <td align="center">
                                               	<select name="review_like_user_id" id="review_like_user_id" 
                                ...
                                <table cellpadding="0" cellspacing="0" class="Panel">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <a href="review_likes.php?sortby=user_asc&page=<?php echo $page;?>&key=<?php echo $key;?>" class="link_class">Like User</a>
                                        <?php }else{?>
                                        <a href="review_likes.php?sortby=user_desc&page=<?php echo $page;?>&key=<?php echo $key;?>" class="link_class">Like User</a>
                                        <?php }?>
                                        </td>
                                        ...
                                        <a href="review_likes.php?sortby=date_asc&page=<?php echo $page;?>&key=<?php echo $key;?>" class="link_class">Like Date</a>
                                        <?php }else{?>
                                        <a href="review_likes.php?sortby=date_desc&page=<?php echo $page;?>&key=<?php echo $key;?>" class="link_class">date_desc</a>
                                        <?php }?>
                                        </td>
									  ...
									  <form action="<?php echo SERVER_ADMIN_PATH; ?>process/review_like_actions.php" method="post" id="like_review_form">
									  <?php
    ...
    &nbsp;&nbsp; <input type="checkbox" class="check-all" name="review_like_ids[]" id="review_like_ids[]" value="<?php echo base64_encode($review_like_id);?>" style="margin-top:-5px;" />
									...
									?>
									  ...
									  ?>
									  <tr>
                                        <td colspan="4" align="center" valign="middle"><?php include("common/report_paging.php"); ?></td>
                                      </tr>
									  </form>
