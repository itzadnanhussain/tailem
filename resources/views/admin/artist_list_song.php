...
<table style="border-collapse: collapse;" border="0" cellpadding="0" width="100%" height="100%">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a href="<?php echo SERVER_ADMIN_PATH;?>song_list.php">Songs Listing</a>&raquo; <a><?php echo stripslashes($song_list_arr['song_title']);?></a></td>
                              </tr>
                              <!--<tr>
                                <td>
    ...
    &nbsp;&nbsp; <input type="checkbox" class="check-all" name="ids[]" id="ids[]" value="<?php echo base64_encode($id);?>" style="margin-top:-5px;" />
										...
										?>
                                        &nbsp; &nbsp;
                                        <a href="<?php echo SERVER_ADMIN_PATH;?>artist_list_album_song.php?song_id=<?php echo base64_encode($song_id);?>&artist_id=<?php echo base64_encode($artist_id);?>">Album</a>
                                        <?php
										}
										?>
                                        </td>
