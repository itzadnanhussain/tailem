...
if($edit_id!=""){
	...
	$row  =  $db->get_row("select ad_id,ad_place,ad_script from tbl_advertisement where ad_id='".$edit_id."'",ARRAY_A);
	$ad_id 	     = $row['ad_id'];
											...
											<table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
											  <tbody>
												<tr>
												  ...
												  &raquo; <a href="<?php echo SERVER_ADMIN_PATH;?>ads_list.php">Advertisement Listing</a>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <select name="ad_place" id="ad_place" class="Field300" style="width:251px;">
                    	...
                    	<option value="Top" <?php if($ad_place=="Top"){ echo "selected='selected'";}?>>Top</option>
                        <option value="Right" <?php if($ad_place=="Right"){ echo "selected='selected'";}?>> Right</option>
						<option value="Bottom" <?php if($ad_place=="Bottom"){ echo "selected='selected'";}?>> Bottom</option>
