                      ...
                      <tr>
                        <td class="body"><form name="setting_frm" id="setting_frm" action="" onSubmit="return chk_setting_frm();">
                            <table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tbody>
                                <tr>
                                  <td style="padding-left:8px;"><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a>Email Templates Listing</a></td>
                                </tr>
                                <tr>
                                      ...
                                      <tbody>
                                        ...
                                        <tr bgcolor="<?php echo $bgcolor; ?>" onMouseOver="changebackcolor_hover('row<?php echo $etemp_id;?>')" onMouseOut="changebackcolor_blur('row<?php echo $etemp_id;?>')" id="row<?php echo $etemp_id;?>">
                                          ...
                                          <td nowrap="nowrap" class="SmallFieldLabel righttd_border">
                                            &nbsp; <a href="edit_email_template.php?edit_id=<?php echo base64_encode($etemp_id);?>"><img src="images/edit.gif" border="0" title="Edit" class="Action"></a></td>
                                           <?php
										   }
										   ?>
                                        </tr>
