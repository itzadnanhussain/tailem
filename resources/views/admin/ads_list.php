...
if(isset($_POST['filter']))
{
	...
	if($_REQUEST['ad_place']!="")
	{
		 ...
		 $_SESSION['ad_place_sess'] = trim($_REQUEST['ad_place']);
	}
	else
	{
		unset($_SESSION['ad_place_sess']);
	}
	
	if($_REQUEST['ads_status'] != "")
	{
		$sess_where .= " and status = '".$_REQUEST['ads_status']."'";
		$_SESSION['ads_status_sess'] = $_REQUEST['ads_status'];
	}
	else
	{
		unset($_SESSION['ads_status_sess']);
	}
	$_SESSION['ads_sess'] = $sess_where;
}
 $session_where = $_SESSION['ads_sess'];
if(isset($_POST['Reset']))
{
	unset($_SESSION['ad_place_sess']);
	$_SESSION['ad_place_sess']="";
	
	unset($_SESSION['ads_status_sess']);
	$_SESSION['ads_status_sess']="";

	unset($_SESSION['ads_sess']);
	$_SESSION['ads_sess']="";
...
<table style="border-collapse: collapse;" border="0" cellpadding="0" width="100%" height="100%">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="body"><table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr>
                                <td><a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; <a>Advertisement Listing</a></td>
                              </tr>
                              <tr>
                                <td>
                                            ...
                                            <tr height="30">
                                                ...
                                                <td align="center">
                                                    <select name="ad_place" id="ad_place" class="Field300">
                                                        ...
                                                        <option value="Top" <?php if($_SESSION['ad_place_sess']=="Top"){ echo "selected='selected'";}?>>Top</option>
                                                        <option value="Right" <?php if($_SESSION['ad_place_sess']=="Right"){ echo "selected='selected'";}?>> Right</option>
                                                        <option value="Bottom" <?php if($_SESSION['ad_place_sess']=="Bottom"){ echo "selected='selected'";}?>> Bottom</option>
                                                </select>
                                                </td>
                                            </tr>
                                            <tr height="30">
                                                ...
                                                <select name="ads_status" id="ads_status" class="Field300">
                                                    ...
                                                    <option value="1" <?php if($_SESSION['ads_status_sess'] == '1'){ echo 'selected="selected"';}?>>Active</option>
                                                    <option value="0" <?php if($_SESSION['ads_status_sess'] == '0'){ echo 'selected="selected"';}?>>Block</option>	
                                                 </select>
                                                 </td>
                                            </tr>
                                    ...
                                    <tbody>
									  ...
									  <tr>
										  <td colspan="5" width="105" align="right" valign="middle" id="addsymbol" >
											<a href="<?php echo SERVER_ADMIN_PATH; ?>addedit_ads.php"><img src="images/add.png" border="0" title="Add New Subject"></a>
                                          </td>
									  </tr>
                                      ...
                                      <tr>
                                        ...
                                        <a href="ads_list.php?sortby=ad_place_asc&page=<?php echo $page;?>" class="link_class">Ads Place</a>
                                        <?php }else{?>
                                        <a href="ads_list.php?sortby=ad_place_desc&page=<?php echo $page;?>" class="link_class">Ads Place</a>
                                        <?php }?>
                                        </td>
                                        <td width="420" id="Heading_list">Google Adsense Code</td>
                                        <td width="90" id="Heading_list">
                                        <?php if($sortby == 'statusdesc'){?>
                                        <a href="ads_list.php?sortby=statusasc&page=<?php echo $page;?>" class="link_class">Status</a>
                                        <?php }else{?>
                                        <a href="ads_list.php?sortby=statusdesc&page=<?php echo $page;?>" class="link_class">Status</a>
                                        <?php }?>
                                        </td>
									  ...
									  <form action="<?php echo SERVER_ADMIN_PATH; ?>process/ads_actions.php" method="post" id="ads_form">
									  <?php
										//============================================================
											...
											$targetpage = "ads_list.php"; //your file name  (the name of this file)
									  ...
									  <tr bgcolor="<?php echo $bgcolor; ?>" onMouseOver="changebackcolor_hover('row<?php echo $ad_id;?>')" onMouseOut="changebackcolor_blur('row<?php echo $ad_id;?>')" id="row<?php echo $ad_id;?>">
										...
										if($status==1)
										{
										  ...
										  <?php
											if($status==0)
											{
												echo '<a href="ads_list.php?status='.base64_encode(1).'&status_id='.base64_encode($ad_id).'"><img src="images/disable.gif" border="0" class="Action" title="Activate"></a>'; 
											}
											if($status==1)
											{
												echo '<a href="ads_list.php?status='.base64_encode(0).'&status_id='.base64_encode($ad_id).'"><img src="images/enable.gif" border="0" class="Action" title="Blocked"></a>'; 
											}
										  ?></td>
    ...
    &nbsp;&nbsp; <input type="checkbox" class="check-all" name="ad_ids[]" id="ad_ids[]" value="<?php echo base64_encode($ad_id);?>" style="margin-top:-5px;" />
										...
										{
										?>
                                        <a href="addedit_ads.php?edit_id=<?php echo base64_encode($ad_id);?>"><img src="images/edit.gif" border="0" title="Edit" class="Action"></a>
                                        <?php	
										}
									    ?>
										<?php
