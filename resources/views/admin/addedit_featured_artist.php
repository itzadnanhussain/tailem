...
include("common/security.php");
    ...
    $main_artist = trim($_REQUEST['artist_id']);
	...
	$song_list_arr  =  $db->get_row("select song_title from tbl_songs where id='".$dec_song_id."'",ARRAY_A);
	$song_title 	= stripslashes(html_entity_decode($song_list_arr['song_title']));
	
	$song_list_arr  =  $db->get_row("select artist_name from tbl_artists where id='".$dec_artist_id."'",ARRAY_A);
...
/* show association*/
$row_result  =  $db->get_results($queryz,ARRAY_A);
										...
										<td class="body">
											<table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%">
											  <tbody>
												<tr>
												  <td align="left">
												 <a href="<?php echo SERVER_ADMIN_PATH;?>index.php">Home</a> &raquo; 
                                                 <a href="<?php echo SERVER_ADMIN_PATH;?>song_list.php">Songs Listing</a>&raquo; 
                                                 <a href="<?php echo SERVER_ADMIN_PATH;?>artist_list_song.php?song_id=<?php echo $song_id;?>"><?php echo stripslashes($song_title);?></a>
                               
                                 &raquo;  <a href="artist_album_songs_list.php?artist_id=<?php echo $main_artist;?>&album_id=<?php echo $album_id;?>"><?php echo stripslashes($artist_name);?></a>
