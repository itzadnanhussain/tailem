    ...
    <div class="banner">
        <div class="banner_body">
            ...
            <div class="banner-search">
                <form
                    action="<?php echo SERVER_ROOTPATH; ?>searcher-results-artist"
                    method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                            ...
                            id="search" name="search" placeholder="Search for an Artist" required>
                        <!--<button type="submit" type="submit" name="submit_ba" id="submit_ba" class="btn">Submit</button>-->

                        <button name="submitbtn" value="Search" type="submit" class="btn"><i
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-11 col-xs-12">
                                    ...
                                    <div class="album_details" style="margin-top:0; padding: 2% 0 0 4%;">
                                        ...
                                        <label class="review_ipad_txt title"><a
                                                href="<?php echo SERVER_ROOTPATH . Slug($artist_seo) . "/artist-songs"; ?>"><?php echo substr($artist_name, 0, 16);
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" style="padding:0px !important;">
                                    <div class="album_details" style="margin-top:0;">
                                        <label class="title"><a
                                                href="<?php echo SERVER_ROOTPATH . Slug($artist_seo) . "/artist-songs"; ?>"><?php echo substr($artist_name, 0, 22);
