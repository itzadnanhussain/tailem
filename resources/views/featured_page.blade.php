                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <p style="padding:5px;">
                                        ...
                                        <a
                                            href="<?php echo SERVER_ROOTPATH . Slug($artist_seo) . "/artist-albums"; ?>">Albums</a>
                                        -
                                        <a class="heart_color"
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0 26px;">
                                    ...
                                    <div class="album_cover" style="float:left; padding: 0 5px 0 0; width:auto;">
                                        ...
                                        } else { ?> <cite class="score_big mt-10"
                                            style="background-color:#dd554e; left:3px;">0.0</cite> <?php } ?>
                                    </div>
                                ...
                                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12" style="padding-left:0px;">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-8 col-xs-8">
                                        <div class="album_details" style="width:100%;">
                                            <label class="title"><a
                                                    href="<?php echo SERVER_ROOTPATH . $song_seo . "/reviews/" . $artist_seo; ?>"><?php echo $song_title; ?></a></label>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ipad_show_div"
                                        ...
                                        <a data-title="" data-target="#show_playlist" data-toggle="modal"
                                            href="<?php echo SERVER_ROOTPATH; ?>add-playlist?song_id=<?php echo $id; ?>&art_id=<?php echo $dbart_id; ?>"
                                            style="padding:0; float:right; margin-right:6px;"><img
                                                src="<?php echo addtoplaylist_icon(); ?>"
                                                title="Add to Playlist" /></a>
                                        <?php
                                    ...
                                    <div class="show_default">
                                        ...
                                        <a class="playlist_icon" data-title="" data-target="#show_playlist"
                                            data-toggle="modal"
                                            href="<?php echo SERVER_ROOTPATH; ?>add-playlist?song_id=<?php echo $id; ?>&art_id=<?php echo $dbart_id; ?>"><img
                                                src="<?php echo addtoplaylist_icon(); ?>"
                                                title="Add to Playlist" /></a>
                                        <?php
                                                } ?>
                                        <div class="clear"></div>
                                        <a href="<?php echo SERVER_ROOTPATH . Slug($song_seo) . "/write-a-review/" . Slug($artist_seo); ?>"
                                            style="margin-top:17px; float:right;"><button>Write a review</button></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-right:2px !important;">
                                            ...
                                            <?php
                                                        if ($picture != "") {
                                                            ...
                                                            if ($img_api_link != '') {
                                                                ?>
                                            <img src="<?php echo $img_api_link; ?>"
                                                border="0" width="120" style="max-width:inherit; " />
                                            <?php
                                                            } else { ?>
                                            <img src="<?php echo SERVER_ROOTPATH; ?>site_upload/song_images/<?php echo 'thumb_' . $picture; ?>"
                                                border="0" width="120" style="max-width:inherit; " />
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9" style="padding:0px !important;">
                                    <div class="album_details" style="width:100%;">
                                        ...
                                        <p><label class="reviews"><img
                                                    src="<?php echo SERVER_ROOTPATH; ?>images/review-book.png"><a
                                                    href="#">Reviews <span><?php echo $review_list_arr_top['count_reviews']; ?></span></a></label><label
                                                class="reviews"><img
                                                    src="<?php echo SERVER_ROOTPATH; ?>images/icon_post.png"><a
                                                    href="#">Posts <span><?php echo $comment_list_arr['count_discussion']; ?></span></a></label>
                                        </p>
