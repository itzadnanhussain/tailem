...
function forgot_pass_validation() {
    ...
    var t = {
        ...
        url: JS_SERVER_PATHROOT + "process/forgot_process.php",
    };
...
function add_in_favourite_list(t, e, i) {
    $.post(
        JS_SERVER_PATHROOT +
            "process/favourite_like.php?prod_id=" +
            t +
            "&artist_seo=" +
            e +
            "&m=" +
...
function add_in_favourite_list_sub_artist_pop(t, e, i) {
    $.post(
        JS_SERVER_PATHROOT +
            "process/favourite_like_sub_artist_pop.php?prod_id=" +
            t +
            "&sr_no=" +
            e +
            "&artist_seo=" +
...
function delete_notification(t) {
    "" != t &&
        $.post(
            JS_SERVER_PATHROOT + "process/delete_notification.php?id=" + t,
            function (t) {
                return "Please sign in first" == t
                    ? (alert(t), !1)
                    : -1 == t.search("done")
