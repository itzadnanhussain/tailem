...
function keynumber(evt)

 {
	...
	if((charCode >45 && charCode <59) || (charCode == 32)||(charCode == 8)||(charCode == 9) ||(charCode == 13)||(charCode == 127)) 
...
function validate_admin_password (){
	...
	$('#change_pass_form').unbind('submit');
		...
		url: JS_ADMIN_SERVER_PATHROOT+'process/admin_change_password_process.php'
...

{
...

	{
		...
		window.location.href = JS_ADMIN_SERVER_PATHROOT+"countries_listing.php";
...
{	
...

	{
		...
		$.ajax({
		   ...
		   url: JS_ADMIN_SERVER_PATHROOT+'process/delete_sub_cate_more_info_data.php',
...
function delete_artist(del_id)
{
...

	{
		...
		$.ajax({
		   ...
		   url: JS_ADMIN_SERVER_PATHROOT+'process/delete_artist.php',
...
{		
...

	{
		...
		$.ajax({
		   ...
		   url: JS_ADMIN_SERVER_PATHROOT+'process/delete_moderator_process.php',
...

{
...

	{
		...
		window.location.href = JS_ADMIN_SERVER_PATHROOT+"report_checkbox_list.php";
...
{		
...

	{
		...
		$.ajax({
		   ...
		   url: JS_ADMIN_SERVER_PATHROOT+'process/delete_gcomment_report.php',
...
{		
...

	{
		...
		$.ajax({
		   ...
		   url: JS_ADMIN_SERVER_PATHROOT+'process/delete_product_embed_code.php',
...

{
...

	{
		...
		window.location.href = JS_ADMIN_SERVER_PATHROOT+"category_image_list.php";
...
function get_category_level4_attributes(id)
{
	if(id!='')
	{
		...
		$.ajax({
		   ...
		   url: JS_ADMIN_SERVER_PATHROOT+'process/category_level4_attributes_process.php',
...
function get_category_level5_attributes(id)
{
	if(id!='')
	{
		...
		$.ajax({
		   ...
		   url: JS_ADMIN_SERVER_PATHROOT+'process/category_level5_attributes_process.php',
...
function get_category_level2_details(level1_id)
{
	if(level1_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/category_level2_details_process.php',
...
function get_category_level3_details(level2_id)
{
	if(level2_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/category_level3_details_process.php',
...
function get_category_level4_details(level3_id)
{
	if(level3_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/category_level4_details_process.php',
...
function get_category_level5_details(level4_id)
{
	if(level4_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/category_level5_details_process.php',
...
function validate_category_more_info(){
	$('#more_info_form').unbind('submit');
		...
		url: JS_ADMIN_SERVER_PATHROOT+'process/category_more_info_process.php'
	};
	// bind to the form's submit event
...
function validate_category_more_info_Response(responseText, statusText)
{
	...
	{
		alert("Record Saved Successfully");
		window.location.href = JS_ADMIN_SERVER_PATHROOT+"sub_cat_more_info_list.php";
	}
	else
	{
		alert(responseText);
...
function get_category_level2_data(level1_id)
{
	if(level1_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/category_level2_data_process.php',
		   data: 'level1_id='+level1_id,
		   beforeSend: function(){
			   $("#level5_attributes_id").hide();
			   $("#load_level2_id").hide();
...
function get_category_level4_data(level3_id)
{
	if(level3_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/category_level4_data_process.php',
		   data: 'level3_id='+level3_id,
		   beforeSend: function(){
			 $("#level5_attributes_id").hide();
		     $("#load_level4_id").hide();
...
function edit_category_level2_details(level1_id,selected_level2_id)
{
	if(level1_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/edit_category_level2_details_process.php',
		   data: 'level1_id='+level1_id+'&selected_level2_id='+selected_level2_id,
		   beforeSend: function(){
			   $("#level5_attributes_id").hide();
			   $("#load_level2_id").hide();
			   $("#load_level3_id").hide();
...
function edit_category_level3_details(level2_id,selected_id)
{
	if(level2_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/edit_category_level3_details_process.php',
		   data: 'level2_id='+level2_id+'&selected_level2_id='+selected_id,
		   beforeSend: function(){
			$("#level5_attributes_id").hide();
			$("#load_level3_id").hide();
	   		$("#load_level4_id").hide();
...
function edit_category_level4_details(level3_id,selected_id)
{
	if(level3_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/edit_category_level4_details_process.php',
		   data: 'level3_id='+level3_id+'&selected_level3_id='+selected_id,
		   beforeSend: function(){
			 $("#level5_attributes_id").hide();
		     $("#load_level4_id").hide();
		   },
...
function edit_category_level5_details(level4_id,selected_id)
{
	if(level4_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/edit_category_level5_details_process.php',
		   data: 'level4_id='+level4_id+'&selected_level4_id='+selected_id,
		   beforeSend: function(){
...
function edit_category_level5_attributes(id)
{
	if(id!='')
	{
		...
		$.ajax({
		   ...
		   url: JS_ADMIN_SERVER_PATHROOT+'process/edit_category_level5_attributes_process.php',
...
function category_level2_review(level1_id)
{
	if(level1_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/category_level2_review_process.php',
		   data: 'level1_id='+level1_id,
		   beforeSend: function(){
			   $("#load_level5_id").hide();
			   $("#load_level2_id").hide();
...
function category_level3_review(level2_id)
{
	if(level2_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/category_level3_review_process.php',
		   data: 'level2_id='+level2_id,
		   beforeSend: function(){
			$("#load_level5_id").hide();
			$("#load_level3_id").hide();
...
function category_level4_review(level3_id)
{
	if(level3_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/category_level4_review_process.php',
		   data: 'level3_id='+level3_id,
		   beforeSend: function(){
			 $("#load_level5_id").hide();
		     $("#load_level4_id").hide();
...
function get_category_level5_review(level4_id)
{
	if(level4_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/category_level5_review_process.php',
		   data: 'level4_id='+level4_id,
		   beforeSend: function(){
...
function edit_category_level2_review(level1_id,reviews_id)
{
	if(level1_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/edit_category_level2_review_process.php',
...
function edit_category_level3_review(level2_id,reviews_id)
{
	if(level2_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/edit_category_level3_review_process.php',
...
function edit_category_level4_review(level3_id,reviews_id)
{
	if(level3_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/edit_category_level4_review_process.php',
...
function edit_category_level5_review(level4_id,reviews_id)
{
	if(level4_id!='')
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/edit_category_level5_review_process.php',
...
{		
	...
	var conBox = confirm("Are you sure,You want to set this as Featured Review?");
...

	{
		...
		$.ajax({
		   ...
		   url: JS_ADMIN_SERVER_PATHROOT+'process/featured_review_process.php',
		   ...
		   success: function(msg)
		   {
			   ...
			   {
				   alert('You have already select Feature Review for this category');
			   }
			   else
			   {
				  alert('Some Error occured in updating Record');
...
{		
	var conBox = confirm("Are you sure,You want to set this as Featured Topic?");
	if(conBox)
	{
		$.ajax({
		   type: "POST",
		   url: JS_ADMIN_SERVER_PATHROOT+'process/featured_topic_process.php',
...
function validate_artist(){
	...
	$('#artist_form').unbind('submit');
		...
		url: JS_ADMIN_SERVER_PATHROOT+'process/artist_process.php'
	};
	// bind to the form's submit event
...

{
	...
	document.getElementById("loader").innerHTML = '<img src='+JS_ADMIN_SERVER_PATHROOT+'images/load.gif>';  
	$("#add").hide();
	$("#save").hide();
...

{
...

	{
		...
		window.location.href = JS_ADMIN_SERVER_PATHROOT+"artist_list.php";
...
function validate_featured_atritst_assocs(){
		...
		url: JS_ADMIN_SERVER_PATHROOT+'process/featured_artist_album_assocs.php'
...

{
...

	{
		alert("Record Saved Successfully");
		window.location.href = myarray[1];
		window.location.href = JS_ADMIN_SERVER_PATHROOT+"artist_album_songs_list.php?"+myarray[1];
