...
function limit_text($text, $limit) {
	...
	function song_info($songid)
	{
		  ...
		  $artist_list_arr	=	 $db->get_row($query_list,ARRAY_A);
	...
	{
		global $db;
	 	$counter_main_playlist_like = mysqli_num_rows(mysqli_query($db->dbh, "select id from tbl_likes where like_type = 'playlist' AND like_receive_user = '$id'"));
